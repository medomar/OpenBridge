...
> **Pending:** 1 | **In Progress:** 0 | **Done:** 40
...
| 41  | OB-1090 | **Update `docs/USE_CASES.md`** — add MCP use case section: "Connecting OpenBridge to External Services" with end-to-end examples (send WhatsApp -> Master -> Worker + Canva MCP -> banner created -> result back to WhatsApp). Include setup steps for one real MCP server.                                                                                                                                                                                         | ✅ Done |
