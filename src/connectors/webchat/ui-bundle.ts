...
// Generated: 2026-03-05T00:03:45.367Z
...
<body>
  ...
  <script>
"use strict";(()=>{var ki=Object.create;var Bn=Object.defineProperty;var Ei=Object.getOwnPropertyDescriptor;var yi=Object.getOwnPropertyNames;var xi=Object.getPrototypeOf,wi=Object.prototype.hasOwnProperty;var _i=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var vi=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of yi(t))!wi.call(e,s)&&s!==n&&Bn(e,s,{get:()=>t[s],enumerable:!(i=Ei(t,s))||i.enumerable});return e};var Si=(e,t,n)=>(n=e!=null?ki(xi(e)):{},vi(t||!e||!e.__esModule?Bn(n,"default",{value:e,enumerable:!0}):n,e));var xs=_i((wo,ys)=>{function ls(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{let n=e[t],i=typeof n;(i==="object"||i==="function")&&!Object.isFrozen(n)&&ls(n)}),e}var mt=class{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function cs(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function he(e,...t){let n=Object.create(null);for(let i in e)n[i]=e[i];return t.forEach(function(i){for(let s in i)n[s]=i[s]}),n}var fr="</span>",ns=e=>!!e.scope,mr=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let n=e.split(".");return[\`\${t}\${n.shift()}\`,...n.map((i,s)=>\`\${i}\${"_".repeat(s+1)}\`)].join(" ")}return\`\${t}\${e}\`},Gt=class{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=cs(t)}openNode(t){if(!ns(t))return;let n=mr(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){ns(t)&&(this.buffer+=fr)}value(){return this.buffer}span(t){this.buffer+=\`<span class="\${t}">\`}},ss=(e={})=>{let t={children:[]};return Object.assign(t,e),t},qt=class e{constructor(){this.rootNode=ss(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){let n=ss({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(i=>this._walk(t,i)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{e._collapse(n)}))}},Zt=class extends qt{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){let i=t.root;n&&(i.scope=\`language:\${n}\`),this.add(i)}toHTML(){return new Gt(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function Ye(e){return e?typeof e=="string"?e:e.source:null}function us(e){return Se("(?=",e,")")}function br(e){return Se("(?:",e,")*")}function kr(e){return Se("(?:",e,")?")}function Se(...e){return e.map(n=>Ye(n)).join("")}function Er(e){let t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function jt(...e){return"("+(Er(e).capture?"":"?:")+e.map(i=>Ye(i)).join("|")+")"}function ds(e){return new RegExp(e.toString()+"|").exec("").length-1}function yr(e,t){let n=e&&e.exec(t);return n&&n.index===0}var xr=/\\[(?:[^\\\\\\]]|\\\\.)*\\]|\\(\\??|\\\\([1-9][0-9]*)|\\\\./;function Wt(e,{joinWith:t}){let n=0;return e.map(i=>{n+=1;let s=n,a=Ye(i),r="";for(;a.length>0;){let l=xr.exec(a);if(!l){r+=a;break}r+=a.substring(0,l.index),a=a.substring(l.index+l[0].length),l[0][0]==="\\\\"&&l[1]?r+="\\\\"+String(Number(l[1])+s):(r+=l[0],l[0]==="("&&n++)}return r}).map(i=>\`(\${i})\`).join(t)}var wr=/\\b\\B/,ps="[a-zA-Z]\\\\w*",Xt="[a-zA-Z_]\\\\w*",gs="\\\\b\\\\d+(\\\\.\\\\d+)?",hs="(-?)(\\\\b0[xX][a-fA-F0-9]+|(\\\\b\\\\d+(\\\\.\\\\d*)?|\\\\.\\\\d+)([eE][-+]?\\\\d+)?)",fs="\\\\b(0b[01]+)",_r="!|!=|!==|%|%=|&|&&|&=|\\\\*|\\\\*=|\\\\+|\\\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\\\?|\\\\[|\\\\{|\\\\(|\\\\^|\\\\^=|\\\\||\\\\|=|\\\\|\\\\||~",vr=(e={})=>{let t=/^#![ ]*\\//;return e.binary&&(e.begin=Se(t,/.*\\b/,e.binary,/\\b.*/)),he({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,i)=>{n.index!==0&&i.ignoreMatch()}},e)},Qe={begin:"\\\\\\\\[\\\\s\\\\S]",relevance:0},Sr={scope:"string",begin:"'",end:"'",illegal:"\\\\n",contains:[Qe]},Ar={scope:"string",begin:'"',end:'"',illegal:"\\\\n",contains:[Qe]},Tr={begin:/\\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\\b/},kt=function(e,t,n={}){let i=he({scope:"comment",begin:e,end:t,contains:[]},n);i.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let s=jt("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return i.contains.push({begin:Se(/[ ]+/,"(",s,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),i},Cr=kt("//","$"),Nr=kt("/\\\\*","\\\\*/"),Rr=kt("#","$"),Ir={scope:"number",begin:gs,relevance:0},Lr={scope:"number",begin:hs,relevance:0},Mr={scope:"number",begin:fs,relevance:0},Or={scope:"regexp",begin:/\\/(?=[^/\\n]*\\/)/,end:/\\/[gimuy]*/,contains:[Qe,{begin:/\\[/,end:/\\]/,relevance:0,contains:[Qe]}]},Br={scope:"title",begin:ps,relevance:0},Dr={scope:"title",begin:Xt,relevance:0},Pr={begin:"\\\\.\\\\s*"+Xt,relevance:0},$r=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})},ft=Object.freeze({__proto__:null,APOS_STRING_MODE:Sr,BACKSLASH_ESCAPE:Qe,BINARY_NUMBER_MODE:Mr,BINARY_NUMBER_RE:fs,COMMENT:kt,C_BLOCK_COMMENT_MODE:Nr,C_LINE_COMMENT_MODE:Cr,C_NUMBER_MODE:Lr,C_NUMBER_RE:hs,END_SAME_AS_BEGIN:$r,HASH_COMMENT_MODE:Rr,IDENT_RE:ps,MATCH_NOTHING_RE:wr,METHOD_GUARD:Pr,NUMBER_MODE:Ir,NUMBER_RE:gs,PHRASAL_WORDS_MODE:Tr,QUOTE_STRING_MODE:Ar,REGEXP_MODE:Or,RE_STARTERS_RE:_r,SHEBANG:vr,TITLE_MODE:Br,UNDERSCORE_IDENT_RE:Xt,UNDERSCORE_TITLE_MODE:Dr});function zr(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function Ur(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function Hr(e,t){t&&e.beginKeywords&&(e.begin="\\\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\\\.)(?=\\\\b|\\\\s)",e.__beforeBegin=zr,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function Fr(e,t){Array.isArray(e.illegal)&&(e.illegal=jt(...e.illegal))}function Gr(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function qr(e,t){e.relevance===void 0&&(e.relevance=1)}var Zr=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let n=Object.assign({},e);Object.keys(e).forEach(i=>{delete e[i]}),e.keywords=n.keywords,e.begin=Se(n.beforeMatch,us(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},Kr=["of","and","for","in","not","or","if","then","parent","list","value"],jr="keyword";function ms(e,t,n=jr){let i=Object.create(null);return typeof e=="string"?s(n,e.split(" ")):Array.isArray(e)?s(n,e):Object.keys(e).forEach(function(a){Object.assign(i,ms(e[a],t,a))}),i;function s(a,r){t&&(r=r.map(l=>l.toLowerCase())),r.forEach(function(l){let o=l.split("|");i[o[0]]=[a,Wr(o[0],o[1])]})}}function Wr(e,t){return t?Number(t):Xr(e)?0:1}function Xr(e){return Kr.includes(e.toLowerCase())}var is={},ve=e=>{console.error(e)},rs=(e,...t)=>{console.log(\`WARN: \${e}\`,...t)},Le=(e,t)=>{is[\`\${e}/\${t}\`]||(console.log(\`Deprecated as of \${e}. \${t}\`),is[\`\${e}/\${t}\`]=!0)},bt=new Error;function bs(e,t,{key:n}){let i=0,s=e[n],a={},r={};for(let l=1;l<=t.length;l++)r[l+i]=s[l],a[l+i]=!0,i+=ds(t[l-1]);e[n]=r,e[n]._emit=a,e[n]._multi=!0}function Yr(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw ve("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),bt;if(typeof e.beginScope!="object"||e.beginScope===null)throw ve("beginScope must be object"),bt;bs(e,e.begin,{key:"beginScope"}),e.begin=Wt(e.begin,{joinWith:""})}}function Qr(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw ve("skip, excludeEnd, returnEnd not compatible with endScope: {}"),bt;if(typeof e.endScope!="object"||e.endScope===null)throw ve("endScope must be object"),bt;bs(e,e.end,{key:"endScope"}),e.end=Wt(e.end,{joinWith:""})}}function Vr(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function Jr(e){Vr(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),Yr(e),Qr(e)}function ea(e){function t(r,l){return new RegExp(Ye(r),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(l?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(l,o){o.position=this.position++,this.matchIndexes[this.matchAt]=o,this.regexes.push([o,l]),this.matchAt+=ds(l)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let l=this.regexes.map(o=>o[1]);this.matcherRe=t(Wt(l,{joinWith:"|"}),!0),this.lastIndex=0}exec(l){this.matcherRe.lastIndex=this.lastIndex;let o=this.matcherRe.exec(l);if(!o)return null;let c=o.findIndex((d,p)=>p>0&&d!==void 0),u=this.matchIndexes[c];return o.splice(0,c),Object.assign(o,u)}}class i{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(l){if(this.multiRegexes[l])return this.multiRegexes[l];let o=new n;return this.rules.slice(l).forEach(([c,u])=>o.addRule(c,u)),o.compile(),this.multiRegexes[l]=o,o}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(l,o){this.rules.push([l,o]),o.type==="begin"&&this.count++}exec(l){let o=this.getMatcher(this.regexIndex);o.lastIndex=this.lastIndex;let c=o.exec(l);if(this.resumingScanAtSamePosition()&&!(c&&c.index===this.lastIndex)){let u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,c=u.exec(l)}return c&&(this.regexIndex+=c.position+1,this.regexIndex===this.count&&this.considerAll()),c}}function s(r){let l=new i;return r.contains.forEach(o=>l.addRule(o.begin,{rule:o,type:"begin"})),r.terminatorEnd&&l.addRule(r.terminatorEnd,{type:"end"}),r.illegal&&l.addRule(r.illegal,{type:"illegal"}),l}function a(r,l){let o=r;if(r.isCompiled)return o;[Ur,Gr,Jr,Zr].forEach(u=>u(r,l)),e.compilerExtensions.forEach(u=>u(r,l)),r.__beforeBegin=null,[Hr,Fr,qr].forEach(u=>u(r,l)),r.isCompiled=!0;let c=null;return typeof r.keywords=="object"&&r.keywords.$pattern&&(r.keywords=Object.assign({},r.keywords),c=r.keywords.$pattern,delete r.keywords.$pattern),c=c||/\\w+/,r.keywords&&(r.keywords=ms(r.keywords,e.case_insensitive)),o.keywordPatternRe=t(c,!0),l&&(r.begin||(r.begin=/\\B|\\b/),o.beginRe=t(o.begin),!r.end&&!r.endsWithParent&&(r.end=/\\B|\\b/),r.end&&(o.endRe=t(o.end)),o.terminatorEnd=Ye(o.end)||"",r.endsWithParent&&l.terminatorEnd&&(o.terminatorEnd+=(r.end?"|":"")+l.terminatorEnd)),r.illegal&&(o.illegalRe=t(r.illegal)),r.contains||(r.contains=[]),r.contains=[].concat(...r.contains.map(function(u){return ta(u==="self"?r:u)})),r.contains.forEach(function(u){a(u,o)}),r.starts&&a(r.starts,l),o.matcher=s(o),o}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains \`self\` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=he(e.classNameAliases||{}),a(e)}function ks(e){return e?e.endsWithParent||ks(e.starts):!1}function ta(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return he(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:ks(e)?he(e,{starts:e.starts?he(e.starts):null}):Object.isFrozen(e)?he(e):e}var na="11.11.1",Kt=class extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}},Ft=cs,as=he,os=Symbol("nomatch"),sa=7,Es=function(e){let t=Object.create(null),n=Object.create(null),i=[],s=!0,a="Could not find the language '{}', did you forget to load/include a language module?",r={disableAutodetect:!0,name:"Plain text",contains:[]},l={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\\blang(?:uage)?-([\\w-]+)\\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:Zt};function o(g){return l.noHighlightRe.test(g)}function c(g){let k=g.className+" ";k+=g.parentNode?g.parentNode.className:"";let b=l.languageDetectRe.exec(k);if(b){let w=U(b[1]);return w||(rs(a.replace("{}",b[1])),rs("Falling back to no-highlight mode for this block.",g)),w?b[1]:"no-highlight"}return k.split(/\\s+/).find(w=>o(w)||U(w))}function u(g,k,b){let w="",S="";typeof k=="object"?(w=g,b=k.ignoreIllegals,S=k.language):(Le("10.7.0","highlight(lang, code, ...args) has been deprecated."),Le("10.7.0",\`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277\`),S=g,w=k),b===void 0&&(b=!0);let L={code:w,language:S};ge("before:highlight",L);let H=L.result?L.result:d(L.language,L.code,b);return H.code=L.code,ge("after:highlight",H),H}function d(g,k,b,w){let S=Object.create(null);function L(h,E){return h.keywords[E]}function H(){if(!x.keywords){D.addText(C);return}let h=0;x.keywordPatternRe.lastIndex=0;let E=x.keywordPatternRe.exec(C),_="";for(;E;){_+=C.substring(h,E.index);let T=se.case_insensitive?E[0].toLowerCase():E[0],F=L(x,T);if(F){let[oe,mi]=F;if(D.addText(_),_="",S[T]=(S[T]||0)+1,S[T]<=sa&&(lt+=mi),oe.startsWith("_"))_+=E[0];else{let bi=se.classNameAliases[oe]||oe;ne(E[0],bi)}}else _+=E[0];h=x.keywordPatternRe.lastIndex,E=x.keywordPatternRe.exec(C)}_+=C.substring(h),D.addText(_)}function te(){if(C==="")return;let h=null;if(typeof x.subLanguage=="string"){if(!t[x.subLanguage]){D.addText(C);return}h=d(x.subLanguage,C,!0,On[x.subLanguage]),On[x.subLanguage]=h._top}else h=m(C,x.subLanguage.length?x.subLanguage:null);x.relevance>0&&(lt+=h.relevance),D.__addSublanguage(h._emitter,h.language)}function j(){x.subLanguage!=null?te():H(),C=""}function ne(h,E){h!==""&&(D.startScope(E),D.addText(h),D.endScope())}function Rn(h,E){let _=1,T=E.length-1;for(;_<=T;){if(!h._emit[_]){_++;continue}let F=se.classNameAliases[h[_]]||h[_],oe=E[_];F?ne(oe,F):(C=oe,H(),C=""),_++}}function In(h,E){return h.scope&&typeof h.scope=="string"&&D.openNode(se.classNameAliases[h.scope]||h.scope),h.beginScope&&(h.beginScope._wrap?(ne(C,se.classNameAliases[h.beginScope._wrap]||h.beginScope._wrap),C=""):h.beginScope._multi&&(Rn(h.beginScope,E),C="")),x=Object.create(h,{parent:{value:x}}),x}function Ln(h,E,_){let T=yr(h.endRe,_);if(T){if(h["on:end"]){let F=new mt(h);h["on:end"](E,F),F.isMatchIgnored&&(T=!1)}if(T){for(;h.endsParent&&h.parent;)h=h.parent;return h}}if(h.endsWithParent)return Ln(h.parent,E,_)}function di(h){return x.matcher.regexIndex===0?(C+=h[0],1):(Nt=!0,0)}function pi(h){let E=h[0],_=h.rule,T=new mt(_),F=[_.__beforeBegin,_["on:begin"]];for(let oe of F)if(oe&&(oe(h,T),T.isMatchIgnored))return di(E);return _.skip?C+=E:(_.excludeBegin&&(C+=E),j(),!_.returnBegin&&!_.excludeBegin&&(C=E)),In(_,h),_.returnBegin?0:E.length}function gi(h){let E=h[0],_=k.substring(h.index),T=Ln(x,h,_);if(!T)return os;let F=x;x.endScope&&x.endScope._wrap?(j(),ne(E,x.endScope._wrap)):x.endScope&&x.endScope._multi?(j(),Rn(x.endScope,h)):F.skip?C+=E:(F.returnEnd||F.excludeEnd||(C+=E),j(),F.excludeEnd&&(C=E));do x.scope&&D.closeNode(),!x.skip&&!x.subLanguage&&(lt+=x.relevance),x=x.parent;while(x!==T.parent);return T.starts&&In(T.starts,h),F.returnEnd?0:E.length}function hi(){let h=[];for(let E=x;E!==se;E=E.parent)E.scope&&h.unshift(E.scope);h.forEach(E=>D.openNode(E))}let ot={};function Mn(h,E){let _=E&&E[0];if(C+=h,_==null)return j(),0;if(ot.type==="begin"&&E.type==="end"&&ot.index===E.index&&_===""){if(C+=k.slice(E.index,E.index+1),!s){let T=new Error(\`0 width match regex (\${g})\`);throw T.languageName=g,T.badRule=ot.rule,T}return 1}if(ot=E,E.type==="begin")return pi(E);if(E.type==="illegal"&&!b){let T=new Error('Illegal lexeme "'+_+'" for mode "'+(x.scope||"<unnamed>")+'"');throw T.mode=x,T}else if(E.type==="end"){let T=gi(E);if(T!==os)return T}if(E.type==="illegal"&&_==="")return C+=\`
\`,1;if(Ct>1e5&&Ct>E.index*3)throw new Error("potential infinite loop, way more iterations than matches");return C+=_,_.length}let se=U(g);if(!se)throw ve(a.replace("{}",g)),new Error('Unknown language: "'+g+'"');let fi=ea(se),Tt="",x=w||fi,On={},D=new l.__emitter(l);hi();let C="",lt=0,ye=0,Ct=0,Nt=!1;try{if(se.__emitTokens)se.__emitTokens(k,D);else{for(x.matcher.considerAll();;){Ct++,Nt?Nt=!1:x.matcher.considerAll(),x.matcher.lastIndex=ye;let h=x.matcher.exec(k);if(!h)break;let E=k.substring(ye,h.index),_=Mn(E,h);ye=h.index+_}Mn(k.substring(ye))}return D.finalize(),Tt=D.toHTML(),{language:g,value:Tt,relevance:lt,illegal:!1,_emitter:D,_top:x}}catch(h){if(h.message&&h.message.includes("Illegal"))return{language:g,value:Ft(k),illegal:!0,relevance:0,_illegalBy:{message:h.message,index:ye,context:k.slice(ye-100,ye+100),mode:h.mode,resultSoFar:Tt},_emitter:D};if(s)return{language:g,value:Ft(k),illegal:!1,relevance:0,errorRaised:h,_emitter:D,_top:x};throw h}}function p(g){let k={value:Ft(g),illegal:!1,relevance:0,_top:r,_emitter:new l.__emitter(l)};return k._emitter.addText(g),k}function m(g,k){k=k||l.languages||Object.keys(t);let b=p(g),w=k.filter(U).filter(Ie).map(j=>d(j,g,!1));w.unshift(b);let S=w.sort((j,ne)=>{if(j.relevance!==ne.relevance)return ne.relevance-j.relevance;if(j.language&&ne.language){if(U(j.language).supersetOf===ne.language)return 1;if(U(ne.language).supersetOf===j.language)return-1}return 0}),[L,H]=S,te=L;return te.secondBest=H,te}function f(g,k,b){let w=k&&n[k]||b;g.classList.add("hljs"),g.classList.add(\`language-\${w}\`)}function y(g){let k=null,b=c(g);if(o(b))return;if(ge("before:highlightElement",{el:g,language:b}),g.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset \`dataset.highlighted\`.",g);return}if(g.children.length>0&&(l.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(g)),l.throwUnescapedHTML))throw new Kt("One of your code blocks includes unescaped HTML.",g.innerHTML);k=g;let w=k.textContent,S=b?u(w,{language:b,ignoreIllegals:!0}):m(w);g.innerHTML=S.value,g.dataset.highlighted="yes",f(g,b,S.language),g.result={language:S.language,re:S.relevance,relevance:S.relevance},S.secondBest&&(g.secondBest={language:S.secondBest.language,relevance:S.secondBest.relevance}),ge("after:highlightElement",{el:g,result:S,text:w})}function R(g){l=as(l,g)}let M=()=>{z(),Le("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function O(){z(),Le("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let $=!1;function z(){function g(){z()}if(document.readyState==="loading"){$||window.addEventListener("DOMContentLoaded",g,!1),$=!0;return}document.querySelectorAll(l.cssSelector).forEach(y)}function I(g,k){let b=null;try{b=k(e)}catch(w){if(ve("Language definition for '{}' could not be registered.".replace("{}",g)),s)ve(w);else throw w;b=r}b.name||(b.name=g),t[g]=b,b.rawDefinition=k.bind(null,e),b.aliases&&K(b.aliases,{languageName:g})}function N(g){delete t[g];for(let k of Object.keys(n))n[k]===g&&delete n[k]}function Ee(){return Object.keys(t)}function U(g){return g=(g||"").toLowerCase(),t[g]||t[n[g]]}function K(g,{languageName:k}){typeof g=="string"&&(g=[g]),g.forEach(b=>{n[b.toLowerCase()]=k})}function Ie(g){let k=U(g);return k&&!k.disableAutodetect}function Fe(g){g["before:highlightBlock"]&&!g["before:highlightElement"]&&(g["before:highlightElement"]=k=>{g["before:highlightBlock"](Object.assign({block:k.el},k))}),g["after:highlightBlock"]&&!g["after:highlightElement"]&&(g["after:highlightElement"]=k=>{g["after:highlightBlock"](Object.assign({block:k.el},k))})}function Ge(g){Fe(g),i.push(g)}function qe(g){let k=i.indexOf(g);k!==-1&&i.splice(k,1)}function ge(g,k){let b=g;i.forEach(function(w){w[b]&&w[b](k)})}function Ze(g){return Le("10.7.0","highlightBlock will be removed entirely in v12.0"),Le("10.7.0","Please use highlightElement now."),y(g)}Object.assign(e,{highlight:u,highlightAuto:m,highlightAll:z,highlightElement:y,highlightBlock:Ze,configure:R,initHighlighting:M,initHighlightingOnLoad:O,registerLanguage:I,unregisterLanguage:N,listLanguages:Ee,getLanguage:U,registerAliases:K,autoDetection:Ie,inherit:as,addPlugin:Ge,removePlugin:qe}),e.debugMode=function(){s=!1},e.safeMode=function(){s=!0},e.versionString=na,e.regex={concat:Se,lookahead:us,either:jt,optional:kr,anyNumberOfTimes:br};for(let g in ft)typeof ft[g]=="object"&&ls(ft[g]);return Object.assign(e,ft),e},Me=Es({});Me.newInstance=()=>Es({});ys.exports=Me;Me.HighlightJS=Me;Me.default=Me});var X=null;function Dn(e){function t(){var n=location.protocol==="https:"?"wss:":"ws:",i=n+"//"+location.host,s=new URLSearchParams(location.search),a=s.get("token");a&&(i+="?token="+encodeURIComponent(a)),X=new WebSocket(i),X.onopen=function(){e.onOpen()},X.onclose=function(){X=null,e.onClose(),setTimeout(t,2e3)},X.onmessage=function(r){try{let l=JSON.parse(r.data);e.onMessage(l)}catch{}},X.onerror=function(){}}t()}function W(e){X&&X.readyState===WebSocket.OPEN&&X.send(JSON.stringify(e))}function Pn(){return X!==null&&X.readyState===WebSocket.OPEN}function Mt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var _e=Mt();function qn(e){_e=e}var xe={exec:()=>null};function v(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(s,a)=>{let r=typeof a=="string"?a:a.source;return r=r.replace(q.caret,"$1"),n=n.replace(s,r),i},getRegex:()=>new RegExp(n,t)};return i}var Ai=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),q={codeRemoveIndent:/^(?: {1,4}| {0,3}\\t)/gm,outputLinkReplace:/\\\\([\\[\\]])/g,indentCodeCompensation:/^(\\s+)(?:\`\`\`)/,beginningSpace:/^\\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\\n/g,tabCharGlobal:/\\t/g,multipleSpaceGlobal:/\\s+/g,blankLine:/^[ \\t]*$/,doubleBlankLine:/\\n[ \\t]*\\n[ \\t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\\n {0,3}((?:=+|-+) *)(?=\\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \\t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\\[[ xX]\\] +\\S/,listReplaceTask:/^\\[[ xX]\\] +/,listTaskCheckbox:/\\[[ xX]\\]/,anyLine:/\\n.*\\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\\||\\| *$/g,tableRowBlankLine:/\\n[ \\t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\\s|>)/i,endPreScriptTag:/^<\\/(pre|code|kbd|script)(\\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\\s])\\s+(['"])(.*)\\2/,unicodeAlphaNumeric:/[\\p{L}\\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/g,unescapeTest:/&(#(?:\\d+)|(?:#x[0-9A-Fa-f]+)|(?:\\w+));?/ig,caret:/(^|[^\\[])\\^/g,percentDecode:/%25/g,findPipe:/\\|/g,splitPipe:/ \\|/,slashPipe:/\\\\\\|/g,carriageReturn:/\\r\\n|\\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\\S*/,endingNewline:/\\n$/,listItemRegex:e=>new RegExp(\`^( {0,3}\${e})((?:[	 ][^\\\\n]*)?(?:\\\\n|$))\`),nextBulletRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:[*+-]|\\\\d{1,9}[.)])((?:[ 	][^\\\\n]*)?(?:\\\\n|$))\`),hrRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\\\* *){3,})(?:\\\\n+|$)\`),fencesBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:\\\`\\\`\\\`|~~~)\`),headingBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}#\`),htmlBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}<(?:[a-z].*>|!--)\`,"i"),blockquoteBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}>\`)},Ti=/^(?:[ \\t]*(?:\\n|$))+/,Ci=/^((?: {4}| {0,3}\\t)[^\\n]+(?:\\n(?:[ \\t]*(?:\\n|$))*)?)+/,Ni=/^ {0,3}(\`{3,}(?=[^\`\\n]*(?:\\n|$))|~{3,})([^\\n]*)(?:\\n|$)(?:|([\\s\\S]*?)(?:\\n|$))(?: {0,3}\\1[~\`]* *(?=\\n|$)|$)/,Xe=/^ {0,3}((?:-[\\t ]*){3,}|(?:_[ \\t]*){3,}|(?:\\*[ \\t]*){3,})(?:\\n+|$)/,Ri=/^ {0,3}(#{1,6})(?=\\s|$)(.*)(?:\\n+|$)/,Ot=/ {0,3}(?:[*+-]|\\d{1,9}[.)])/,Zn=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\\n(?!\\s*?\\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,Kn=v(Zn).replace(/bull/g,Ot).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/\\|table/g,"").getRegex(),Ii=v(Zn).replace(/bull/g,Ot).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/table/g,/ {0,3}\\|?(?:[:\\- ]*\\|)+[\\:\\- ]*\\n/).getRegex(),Bt=/^([^\\n]+(?:\\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\\n)[^\\n]+)*)/,Li=/^[^\\n]+/,Dt=/(?!\\s*\\])(?:\\\\[\\s\\S]|[^\\[\\]\\\\])+/,Mi=v(/^ {0,3}\\[(label)\\]: *(?:\\n[ \\t]*)?([^<\\s][^\\s]*|<.*?>)(?:(?: +(?:\\n[ \\t]*)?| *\\n[ \\t]*)(title))? *(?:\\n+|$)/).replace("label",Dt).replace("title",/(?:"(?:\\\\"?|[^"\\\\])*"|'[^'\\n]*(?:\\n[^'\\n]+)*\\n?'|\\([^()]*\\))/).getRegex(),Oi=v(/^(bull)([ \\t][^\\n]+?)?(?:\\n|$)/).replace(/bull/g,Ot).getRegex(),gt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Pt=/<!--(?:-?>|[\\s\\S]*?(?:-->|$))/,Bi=v("^ {0,3}(?:<(script|pre|style|textarea)[\\\\s>][\\\\s\\\\S]*?(?:</\\\\1>[^\\\\n]*\\\\n+|$)|comment[^\\\\n]*(\\\\n+|$)|<\\\\?[\\\\s\\\\S]*?(?:\\\\?>\\\\n*|$)|<![A-Z][\\\\s\\\\S]*?(?:>\\\\n*|$)|<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?(?:\\\\]\\\\]>\\\\n*|$)|</?(tag)(?: +|\\\\n|/?>)[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|<(?!script|pre|style|textarea)([a-z][\\\\w-]*)(?:attribute)*? */?>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|</(?!script|pre|style|textarea)[a-z][\\\\w-]*\\\\s*>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$))","i").replace("comment",Pt).replace("tag",gt).replace("attribute",/ +[a-zA-Z:_][\\w.:-]*(?: *= *"[^"\\n]*"| *= *'[^'\\n]*'| *= *[^\\s"'=<>\`]+)?/).getRegex(),jn=v(Bt).replace("hr",Xe).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gt).getRegex(),Di=v(/^( {0,3}> ?(paragraph|[^\\n]*)(?:\\n|$))+/).replace("paragraph",jn).getRegex(),$t={blockquote:Di,code:Ci,def:Mi,fences:Ni,heading:Ri,hr:Xe,html:Bi,lheading:Kn,list:Oi,newline:Ti,paragraph:jn,table:xe,text:Li},$n=v("^ *([^\\\\n ].*)\\\\n {0,3}((?:\\\\| *)?:?-+:? *(?:\\\\| *:?-+:? *)*(?:\\\\| *)?)(?:\\\\n((?:(?! *\\\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\\\n|$))*)\\\\n*|$)").replace("hr",Xe).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\\\n]").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gt).getRegex(),Pi={...$t,lheading:Ii,table:$n,paragraph:v(Bt).replace("hr",Xe).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("table",$n).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gt).getRegex()},$i={...$t,html:v(\`^ *(?:comment *(?:\\\\n|\\\\s*$)|<(tag)[\\\\s\\\\S]+?</\\\\1> *(?:\\\\n{2,}|\\\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\\\s[^'"/>\\\\s]*)*?/?> *(?:\\\\n{2,}|\\\\s*$))\`).replace("comment",Pt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\\\b)\\\\w+(?!:|[^\\\\w\\\\s@]*@)\\\\b").getRegex(),def:/^ *\\[([^\\]]+)\\]: *<?([^\\s>]+)>?(?: +(["(][^\\n]+[")]))? *(?:\\n+|$)/,heading:/^(#{1,6})(.*)(?:\\n+|$)/,fences:xe,lheading:/^(.+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,paragraph:v(Bt).replace("hr",Xe).replace("heading",\` *#{1,6} *[^
]\`).replace("lheading",Kn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},zi=/^\\\\([!"#$%&'()*+,\\-./:;<=>?@\\[\\]\\\\^_\`{|}~])/,Ui=/^(\`+)([^\`]|[^\`][\\s\\S]*?[^\`])\\1(?!\`)/,Wn=/^( {2,}|\\\\)\\n(?!\\s*$)/,Hi=/^(\`+|[^\`])(?:(?= {2,}\\n)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*_]|\\b_|$)|[^ ](?= {2,}\\n)))/,ht=/[\\p{P}\\p{S}]/u,zt=/[\\s\\p{P}\\p{S}]/u,Xn=/[^\\s\\p{P}\\p{S}]/u,Fi=v(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,zt).getRegex(),Yn=/(?!~)[\\p{P}\\p{S}]/u,Gi=/(?!~)[\\s\\p{P}\\p{S}]/u,qi=/(?:[^\\s\\p{P}\\p{S}]|~)/u,Qn=/(?![*_])[\\p{P}\\p{S}]/u,Zi=/(?![*_])[\\s\\p{P}\\p{S}]/u,Ki=/(?:[^\\s\\p{P}\\p{S}]|[*_])/u,ji=v(/link|precode-code|html/,"g").replace("link",/\\[(?:[^\\[\\]\`]|(?<a>\`+)[^\`]+\\k<a>(?!\`))*?\\]\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)]|\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)])*\\))*\\)/).replace("precode-",Ai?"(?<!\`)()":"(^^|[^\`])").replace("code",/(?<b>\`+)[^\`]+\\k<b>(?!\`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Vn=/^(?:\\*+(?:((?!\\*)punct)|[^\\s*]))|^_+(?:((?!_)punct)|([^\\s_]))/,Wi=v(Vn,"u").replace(/punct/g,ht).getRegex(),Xi=v(Vn,"u").replace(/punct/g,Yn).getRegex(),Jn="^[^_*]*?__[^_*]*?\\\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\\\*)punct(\\\\*+)(?=[\\\\s]|$)|notPunctSpace(\\\\*+)(?!\\\\*)(?=punctSpace|$)|(?!\\\\*)punctSpace(\\\\*+)(?=notPunctSpace)|[\\\\s](\\\\*+)(?!\\\\*)(?=punct)|(?!\\\\*)punct(\\\\*+)(?!\\\\*)(?=punct)|notPunctSpace(\\\\*+)(?=notPunctSpace)",Yi=v(Jn,"gu").replace(/notPunctSpace/g,Xn).replace(/punctSpace/g,zt).replace(/punct/g,ht).getRegex(),Qi=v(Jn,"gu").replace(/notPunctSpace/g,qi).replace(/punctSpace/g,Gi).replace(/punct/g,Yn).getRegex(),Vi=v("^[^_*]*?\\\\*\\\\*[^_*]*?_[^_*]*?(?=\\\\*\\\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Xn).replace(/punctSpace/g,zt).replace(/punct/g,ht).getRegex(),Ji=v(/^~~?(?:((?!~)punct)|[^\\s~])/,"u").replace(/punct/g,Qn).getRegex(),er="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",tr=v(er,"gu").replace(/notPunctSpace/g,Ki).replace(/punctSpace/g,Zi).replace(/punct/g,Qn).getRegex(),nr=v(/\\\\(punct)/,"gu").replace(/punct/g,ht).getRegex(),sr=v(/^<(scheme:[^\\s\\x00-\\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_\`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),ir=v(Pt).replace("(?:-->|$)","-->").getRegex(),rr=v("^comment|^</[a-zA-Z][\\\\w:-]*\\\\s*>|^<[a-zA-Z][\\\\w-]*(?:attribute)*?\\\\s*/?>|^<\\\\?[\\\\s\\\\S]*?\\\\?>|^<![a-zA-Z]+\\\\s[\\\\s\\\\S]*?>|^<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?\\\\]\\\\]>").replace("comment",ir).replace("attribute",/\\s+[a-zA-Z:_][\\w.:-]*(?:\\s*=\\s*"[^"]*"|\\s*=\\s*'[^']*'|\\s*=\\s*[^\\s"'=<>\`]+)?/).getRegex(),ut=/(?:\\[(?:\\\\[\\s\\S]|[^\\[\\]\\\\])*\\]|\\\\[\\s\\S]|\`+[^\`]*?\`+(?!\`)|[^\\[\\]\\\\\`])*?/,ar=v(/^!?\\[(label)\\]\\(\\s*(href)(?:(?:[ \\t]*(?:\\n[ \\t]*)?)(title))?\\s*\\)/).replace("label",ut).replace("href",/<(?:\\\\.|[^\\n<>\\\\])+>|[^ \\t\\n\\x00-\\x1f]*/).replace("title",/"(?:\\\\"?|[^"\\\\])*"|'(?:\\\\'?|[^'\\\\])*'|\\((?:\\\\\\)?|[^)\\\\])*\\)/).getRegex(),es=v(/^!?\\[(label)\\]\\[(ref)\\]/).replace("label",ut).replace("ref",Dt).getRegex(),ts=v(/^!?\\[(ref)\\](?:\\[\\])?/).replace("ref",Dt).getRegex(),or=v("reflink|nolink(?!\\\\()","g").replace("reflink",es).replace("nolink",ts).getRegex(),zn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ut={_backpedal:xe,anyPunctuation:nr,autolink:sr,blockSkip:ji,br:Wn,code:Ui,del:xe,delLDelim:xe,delRDelim:xe,emStrongLDelim:Wi,emStrongRDelimAst:Yi,emStrongRDelimUnd:Vi,escape:zi,link:ar,nolink:ts,punctuation:Fi,reflink:es,reflinkSearch:or,tag:rr,text:Hi,url:xe},lr={...Ut,link:v(/^!?\\[(label)\\]\\((.*?)\\)/).replace("label",ut).getRegex(),reflink:v(/^!?\\[(label)\\]\\s*\\[([^\\]]*)\\]/).replace("label",ut).getRegex()},Rt={...Ut,emStrongRDelimAst:Qi,emStrongLDelim:Xi,delLDelim:Ji,delRDelim:tr,url:v(/^((?:protocol):\\/\\/|www\\.)(?:[a-zA-Z0-9\\-]+\\.?)+[^\\s<]*|^email/).replace("protocol",zn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\\([^)]*\\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\\s~])((?:\\\\[\\s\\S]|[^\\\\])*?(?:\\\\[\\s\\S]|[^\\s~\\\\]))\\1(?=[^~]|$)/,text:v(/^([\`~]+|[^\`~])(?:(?= {2,}\\n)|(?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*~_]|\\b_|protocol:\\/\\/|www\\.|$)|[^ ](?= {2,}\\n)|[^a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-](?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)))/).replace("protocol",zn).getRegex()},cr={...Rt,br:v(Wn).replace("{2,}","*").getRegex(),text:v(Rt.text).replace("\\\\b_","\\\\b_| {2,}\\\\n").replace(/\\{2,\\}/g,"*").getRegex()},ct={normal:$t,gfm:Pi,pedantic:$i},Ke={normal:Ut,gfm:Rt,breaks:cr,pedantic:lr},ur={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Un=e=>ur[e];function ie(e,t){if(t){if(q.escapeTest.test(e))return e.replace(q.escapeReplace,Un)}else if(q.escapeTestNoEncode.test(e))return e.replace(q.escapeReplaceNoEncode,Un);return e}function Hn(e){try{e=encodeURI(e).replace(q.percentDecode,"%")}catch{return null}return e}function Fn(e,t){let n=e.replace(q.findPipe,(a,r,l)=>{let o=!1,c=r;for(;--c>=0&&l[c]==="\\\\";)o=!o;return o?"|":" |"}),i=n.split(q.splitPipe),s=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;s<i.length;s++)i[s]=i[s].trim().replace(q.slashPipe,"|");return i}function je(e,t,n){let i=e.length;if(i===0)return"";let s=0;for(;s<i;){let a=e.charAt(i-s-1);if(a===t&&!n)s++;else if(a!==t&&n)s++;else break}return e.slice(0,i-s)}function dr(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function pr(e,t=0){let n=t,i="";for(let s of e)if(s==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=s,n++;return i}function Gn(e,t,n,i,s){let a=t.href,r=t.title||null,l=e[1].replace(s.other.outputLinkReplace,"$1");i.state.inLink=!0;let o={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:r,text:l,tokens:i.inlineTokens(l)};return i.state.inLink=!1,o}function gr(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let s=i[1];return t.split(\`
\`).map(a=>{let r=a.match(n.other.beginningSpace);if(r===null)return a;let[l]=r;return l.length>=s.length?a.slice(s.length):a}).join(\`
\`)}var dt=class{options;rules;lexer;constructor(e){this.options=e||_e}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let n=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:je(n,\`
