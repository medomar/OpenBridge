...
// Generated: 2026-03-03T21:27:46.018Z
...
<body>
  ...
  <script>
"use strict";(()=>{var Hs=Object.create;var un=Object.defineProperty;var Fs=Object.getOwnPropertyDescriptor;var Gs=Object.getOwnPropertyNames;var qs=Object.getPrototypeOf,Zs=Object.prototype.hasOwnProperty;var Ks=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var js=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Gs(t))!Zs.call(e,s)&&s!==n&&un(e,s,{get:()=>t[s],enumerable:!(i=Fs(t,s))||i.enumerable});return e};var Ws=(e,t,n)=>(n=e!=null?Hs(qs(e)):{},js(t||!e||!e.__esModule?un(n,"default",{value:e,enumerable:!0}):n,e));var Yn=Ks((Ba,Xn)=>{function Pn(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{let n=e[t],i=typeof n;(i==="object"||i==="function")&&!Object.isFrozen(n)&&Pn(n)}),e}var Ve=class{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function $n(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function le(e,...t){let n=Object.create(null);for(let i in e)n[i]=e[i];return t.forEach(function(i){for(let s in i)n[s]=i[s]}),n}var $i="</span>",In=e=>!!e.scope,zi=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let n=e.split(".");return[\`\${t}\${n.shift()}\`,...n.map((i,s)=>\`\${i}\${"_".repeat(s+1)}\`)].join(" ")}return\`\${t}\${e}\`},_t=class{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=$n(t)}openNode(t){if(!In(t))return;let n=zi(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){In(t)&&(this.buffer+=$i)}value(){return this.buffer}span(t){this.buffer+=\`<span class="\${t}">\`}},Ln=(e={})=>{let t={children:[]};return Object.assign(t,e),t},vt=class e{constructor(){this.rootNode=Ln(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){let n=Ln({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(i=>this._walk(t,i)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{e._collapse(n)}))}},St=class extends vt{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){let i=t.root;n&&(i.scope=\`language:\${n}\`),this.add(i)}toHTML(){return new _t(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function Be(e){return e?typeof e=="string"?e:e.source:null}function zn(e){return ke("(?=",e,")")}function Ui(e){return ke("(?:",e,")*")}function Hi(e){return ke("(?:",e,")?")}function ke(...e){return e.map(n=>Be(n)).join("")}function Fi(e){let t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function At(...e){return"("+(Fi(e).capture?"":"?:")+e.map(i=>Be(i)).join("|")+")"}function Un(e){return new RegExp(e.toString()+"|").exec("").length-1}function Gi(e,t){let n=e&&e.exec(t);return n&&n.index===0}var qi=/\\[(?:[^\\\\\\]]|\\\\.)*\\]|\\(\\??|\\\\([1-9][0-9]*)|\\\\./;function Rt(e,{joinWith:t}){let n=0;return e.map(i=>{n+=1;let s=n,a=Be(i),r="";for(;a.length>0;){let l=qi.exec(a);if(!l){r+=a;break}r+=a.substring(0,l.index),a=a.substring(l.index+l[0].length),l[0][0]==="\\\\"&&l[1]?r+="\\\\"+String(Number(l[1])+s):(r+=l[0],l[0]==="("&&n++)}return r}).map(i=>\`(\${i})\`).join(t)}var Zi=/\\b\\B/,Hn="[a-zA-Z]\\\\w*",Nt="[a-zA-Z_]\\\\w*",Fn="\\\\b\\\\d+(\\\\.\\\\d+)?",Gn="(-?)(\\\\b0[xX][a-fA-F0-9]+|(\\\\b\\\\d+(\\\\.\\\\d*)?|\\\\.\\\\d+)([eE][-+]?\\\\d+)?)",qn="\\\\b(0b[01]+)",Ki="!|!=|!==|%|%=|&|&&|&=|\\\\*|\\\\*=|\\\\+|\\\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\\\?|\\\\[|\\\\{|\\\\(|\\\\^|\\\\^=|\\\\||\\\\|=|\\\\|\\\\||~",ji=(e={})=>{let t=/^#![ ]*\\//;return e.binary&&(e.begin=ke(t,/.*\\b/,e.binary,/\\b.*/)),le({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,i)=>{n.index!==0&&i.ignoreMatch()}},e)},Pe={begin:"\\\\\\\\[\\\\s\\\\S]",relevance:0},Wi={scope:"string",begin:"'",end:"'",illegal:"\\\\n",contains:[Pe]},Xi={scope:"string",begin:'"',end:'"',illegal:"\\\\n",contains:[Pe]},Yi={begin:/\\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\\b/},et=function(e,t,n={}){let i=le({scope:"comment",begin:e,end:t,contains:[]},n);i.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let s=At("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return i.contains.push({begin:ke(/[ ]+/,"(",s,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),i},Qi=et("//","$"),Vi=et("/\\\\*","\\\\*/"),Ji=et("#","$"),er={scope:"number",begin:Fn,relevance:0},tr={scope:"number",begin:Gn,relevance:0},nr={scope:"number",begin:qn,relevance:0},sr={scope:"regexp",begin:/\\/(?=[^/\\n]*\\/)/,end:/\\/[gimuy]*/,contains:[Pe,{begin:/\\[/,end:/\\]/,relevance:0,contains:[Pe]}]},ir={scope:"title",begin:Hn,relevance:0},rr={scope:"title",begin:Nt,relevance:0},ar={begin:"\\\\.\\\\s*"+Nt,relevance:0},or=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})},Qe=Object.freeze({__proto__:null,APOS_STRING_MODE:Wi,BACKSLASH_ESCAPE:Pe,BINARY_NUMBER_MODE:nr,BINARY_NUMBER_RE:qn,COMMENT:et,C_BLOCK_COMMENT_MODE:Vi,C_LINE_COMMENT_MODE:Qi,C_NUMBER_MODE:tr,C_NUMBER_RE:Gn,END_SAME_AS_BEGIN:or,HASH_COMMENT_MODE:Ji,IDENT_RE:Hn,MATCH_NOTHING_RE:Zi,METHOD_GUARD:ar,NUMBER_MODE:er,NUMBER_RE:Fn,PHRASAL_WORDS_MODE:Yi,QUOTE_STRING_MODE:Xi,REGEXP_MODE:sr,RE_STARTERS_RE:Ki,SHEBANG:ji,TITLE_MODE:ir,UNDERSCORE_IDENT_RE:Nt,UNDERSCORE_TITLE_MODE:rr});function lr(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function cr(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function ur(e,t){t&&e.beginKeywords&&(e.begin="\\\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\\\.)(?=\\\\b|\\\\s)",e.__beforeBegin=lr,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function dr(e,t){Array.isArray(e.illegal)&&(e.illegal=At(...e.illegal))}function pr(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function gr(e,t){e.relevance===void 0&&(e.relevance=1)}var hr=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let n=Object.assign({},e);Object.keys(e).forEach(i=>{delete e[i]}),e.keywords=n.keywords,e.begin=ke(n.beforeMatch,zn(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},fr=["of","and","for","in","not","or","if","then","parent","list","value"],mr="keyword";function Zn(e,t,n=mr){let i=Object.create(null);return typeof e=="string"?s(n,e.split(" ")):Array.isArray(e)?s(n,e):Object.keys(e).forEach(function(a){Object.assign(i,Zn(e[a],t,a))}),i;function s(a,r){t&&(r=r.map(l=>l.toLowerCase())),r.forEach(function(l){let o=l.split("|");i[o[0]]=[a,br(o[0],o[1])]})}}function br(e,t){return t?Number(t):kr(e)?0:1}function kr(e){return fr.includes(e.toLowerCase())}var Mn={},be=e=>{console.error(e)},On=(e,...t)=>{console.log(\`WARN: \${e}\`,...t)},we=(e,t)=>{Mn[\`\${e}/\${t}\`]||(console.log(\`Deprecated as of \${e}. \${t}\`),Mn[\`\${e}/\${t}\`]=!0)},Je=new Error;function Kn(e,t,{key:n}){let i=0,s=e[n],a={},r={};for(let l=1;l<=t.length;l++)r[l+i]=s[l],a[l+i]=!0,i+=Un(t[l-1]);e[n]=r,e[n]._emit=a,e[n]._multi=!0}function yr(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw be("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Je;if(typeof e.beginScope!="object"||e.beginScope===null)throw be("beginScope must be object"),Je;Kn(e,e.begin,{key:"beginScope"}),e.begin=Rt(e.begin,{joinWith:""})}}function Er(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw be("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Je;if(typeof e.endScope!="object"||e.endScope===null)throw be("endScope must be object"),Je;Kn(e,e.end,{key:"endScope"}),e.end=Rt(e.end,{joinWith:""})}}function xr(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function wr(e){xr(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),yr(e),Er(e)}function _r(e){function t(r,l){return new RegExp(Be(r),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(l?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(l,o){o.position=this.position++,this.matchIndexes[this.matchAt]=o,this.regexes.push([o,l]),this.matchAt+=Un(l)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let l=this.regexes.map(o=>o[1]);this.matcherRe=t(Rt(l,{joinWith:"|"}),!0),this.lastIndex=0}exec(l){this.matcherRe.lastIndex=this.lastIndex;let o=this.matcherRe.exec(l);if(!o)return null;let c=o.findIndex((d,g)=>g>0&&d!==void 0),u=this.matchIndexes[c];return o.splice(0,c),Object.assign(o,u)}}class i{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(l){if(this.multiRegexes[l])return this.multiRegexes[l];let o=new n;return this.rules.slice(l).forEach(([c,u])=>o.addRule(c,u)),o.compile(),this.multiRegexes[l]=o,o}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(l,o){this.rules.push([l,o]),o.type==="begin"&&this.count++}exec(l){let o=this.getMatcher(this.regexIndex);o.lastIndex=this.lastIndex;let c=o.exec(l);if(this.resumingScanAtSamePosition()&&!(c&&c.index===this.lastIndex)){let u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,c=u.exec(l)}return c&&(this.regexIndex+=c.position+1,this.regexIndex===this.count&&this.considerAll()),c}}function s(r){let l=new i;return r.contains.forEach(o=>l.addRule(o.begin,{rule:o,type:"begin"})),r.terminatorEnd&&l.addRule(r.terminatorEnd,{type:"end"}),r.illegal&&l.addRule(r.illegal,{type:"illegal"}),l}function a(r,l){let o=r;if(r.isCompiled)return o;[cr,pr,wr,hr].forEach(u=>u(r,l)),e.compilerExtensions.forEach(u=>u(r,l)),r.__beforeBegin=null,[ur,dr,gr].forEach(u=>u(r,l)),r.isCompiled=!0;let c=null;return typeof r.keywords=="object"&&r.keywords.$pattern&&(r.keywords=Object.assign({},r.keywords),c=r.keywords.$pattern,delete r.keywords.$pattern),c=c||/\\w+/,r.keywords&&(r.keywords=Zn(r.keywords,e.case_insensitive)),o.keywordPatternRe=t(c,!0),l&&(r.begin||(r.begin=/\\B|\\b/),o.beginRe=t(o.begin),!r.end&&!r.endsWithParent&&(r.end=/\\B|\\b/),r.end&&(o.endRe=t(o.end)),o.terminatorEnd=Be(o.end)||"",r.endsWithParent&&l.terminatorEnd&&(o.terminatorEnd+=(r.end?"|":"")+l.terminatorEnd)),r.illegal&&(o.illegalRe=t(r.illegal)),r.contains||(r.contains=[]),r.contains=[].concat(...r.contains.map(function(u){return vr(u==="self"?r:u)})),r.contains.forEach(function(u){a(u,o)}),r.starts&&a(r.starts,l),o.matcher=s(o),o}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains \`self\` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=le(e.classNameAliases||{}),a(e)}function jn(e){return e?e.endsWithParent||jn(e.starts):!1}function vr(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return le(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:jn(e)?le(e,{starts:e.starts?le(e.starts):null}):Object.isFrozen(e)?le(e):e}var Sr="11.11.1",Tt=class extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}},wt=$n,Dn=le,Bn=Symbol("nomatch"),Tr=7,Wn=function(e){let t=Object.create(null),n=Object.create(null),i=[],s=!0,a="Could not find the language '{}', did you forget to load/include a language module?",r={disableAutodetect:!0,name:"Plain text",contains:[]},l={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\\blang(?:uage)?-([\\w-]+)\\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:St};function o(p){return l.noHighlightRe.test(p)}function c(p){let b=p.className+" ";b+=p.parentNode?p.parentNode.className:"";let m=l.languageDetectRe.exec(b);if(m){let w=U(m[1]);return w||(On(a.replace("{}",m[1])),On("Falling back to no-highlight mode for this block.",p)),w?m[1]:"no-highlight"}return b.split(/\\s+/).find(w=>o(w)||U(w))}function u(p,b,m){let w="",S="";typeof b=="object"?(w=p,m=b.ignoreIllegals,S=b.language):(we("10.7.0","highlight(lang, code, ...args) has been deprecated."),we("10.7.0",\`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277\`),S=p,w=b),m===void 0&&(m=!0);let L={code:w,language:S};oe("before:highlight",L);let H=L.result?L.result:d(L.language,L.code,m);return H.code=L.code,oe("after:highlight",H),H}function d(p,b,m,w){let S=Object.create(null);function L(h,k){return h.keywords[k]}function H(){if(!x.keywords){D.addText(R);return}let h=0;x.keywordPatternRe.lastIndex=0;let k=x.keywordPatternRe.exec(R),_="";for(;k;){_+=R.substring(h,k.index);let A=te.case_insensitive?k[0].toLowerCase():k[0],F=L(x,A);if(F){let[ie,zs]=F;if(D.addText(_),_="",S[A]=(S[A]||0)+1,S[A]<=Tr&&(qe+=zs),ie.startsWith("_"))_+=k[0];else{let Us=te.classNameAliases[ie]||ie;ee(k[0],Us)}}else _+=k[0];h=x.keywordPatternRe.lastIndex,k=x.keywordPatternRe.exec(R)}_+=R.substring(h),D.addText(_)}function J(){if(R==="")return;let h=null;if(typeof x.subLanguage=="string"){if(!t[x.subLanguage]){D.addText(R);return}h=d(x.subLanguage,R,!0,cn[x.subLanguage]),cn[x.subLanguage]=h._top}else h=y(R,x.subLanguage.length?x.subLanguage:null);x.relevance>0&&(qe+=h.relevance),D.__addSublanguage(h._emitter,h.language)}function j(){x.subLanguage!=null?J():H(),R=""}function ee(h,k){h!==""&&(D.startScope(k),D.addText(h),D.endScope())}function rn(h,k){let _=1,A=k.length-1;for(;_<=A;){if(!h._emit[_]){_++;continue}let F=te.classNameAliases[h[_]]||h[_],ie=k[_];F?ee(ie,F):(R=ie,H(),R=""),_++}}function an(h,k){return h.scope&&typeof h.scope=="string"&&D.openNode(te.classNameAliases[h.scope]||h.scope),h.beginScope&&(h.beginScope._wrap?(ee(R,te.classNameAliases[h.beginScope._wrap]||h.beginScope._wrap),R=""):h.beginScope._multi&&(rn(h.beginScope,k),R="")),x=Object.create(h,{parent:{value:x}}),x}function on(h,k,_){let A=Gi(h.endRe,_);if(A){if(h["on:end"]){let F=new Ve(h);h["on:end"](k,F),F.isMatchIgnored&&(A=!1)}if(A){for(;h.endsParent&&h.parent;)h=h.parent;return h}}if(h.endsWithParent)return on(h.parent,k,_)}function Os(h){return x.matcher.regexIndex===0?(R+=h[0],1):(ct=!0,0)}function Ds(h){let k=h[0],_=h.rule,A=new Ve(_),F=[_.__beforeBegin,_["on:begin"]];for(let ie of F)if(ie&&(ie(h,A),A.isMatchIgnored))return Os(k);return _.skip?R+=k:(_.excludeBegin&&(R+=k),j(),!_.returnBegin&&!_.excludeBegin&&(R=k)),an(_,h),_.returnBegin?0:k.length}function Bs(h){let k=h[0],_=b.substring(h.index),A=on(x,h,_);if(!A)return Bn;let F=x;x.endScope&&x.endScope._wrap?(j(),ee(k,x.endScope._wrap)):x.endScope&&x.endScope._multi?(j(),rn(x.endScope,h)):F.skip?R+=k:(F.returnEnd||F.excludeEnd||(R+=k),j(),F.excludeEnd&&(R=k));do x.scope&&D.closeNode(),!x.skip&&!x.subLanguage&&(qe+=x.relevance),x=x.parent;while(x!==A.parent);return A.starts&&an(A.starts,h),F.returnEnd?0:k.length}function Ps(){let h=[];for(let k=x;k!==te;k=k.parent)k.scope&&h.unshift(k.scope);h.forEach(k=>D.openNode(k))}let Ge={};function ln(h,k){let _=k&&k[0];if(R+=h,_==null)return j(),0;if(Ge.type==="begin"&&k.type==="end"&&Ge.index===k.index&&_===""){if(R+=b.slice(k.index,k.index+1),!s){let A=new Error(\`0 width match regex (\${p})\`);throw A.languageName=p,A.badRule=Ge.rule,A}return 1}if(Ge=k,k.type==="begin")return Ds(k);if(k.type==="illegal"&&!m){let A=new Error('Illegal lexeme "'+_+'" for mode "'+(x.scope||"<unnamed>")+'"');throw A.mode=x,A}else if(k.type==="end"){let A=Bs(k);if(A!==Bn)return A}if(k.type==="illegal"&&_==="")return R+=\`
\`,1;if(lt>1e5&&lt>k.index*3)throw new Error("potential infinite loop, way more iterations than matches");return R+=_,_.length}let te=U(p);if(!te)throw be(a.replace("{}",p)),new Error('Unknown language: "'+p+'"');let $s=_r(te),ot="",x=w||$s,cn={},D=new l.__emitter(l);Ps();let R="",qe=0,pe=0,lt=0,ct=!1;try{if(te.__emitTokens)te.__emitTokens(b,D);else{for(x.matcher.considerAll();;){lt++,ct?ct=!1:x.matcher.considerAll(),x.matcher.lastIndex=pe;let h=x.matcher.exec(b);if(!h)break;let k=b.substring(pe,h.index),_=ln(k,h);pe=h.index+_}ln(b.substring(pe))}return D.finalize(),ot=D.toHTML(),{language:p,value:ot,relevance:qe,illegal:!1,_emitter:D,_top:x}}catch(h){if(h.message&&h.message.includes("Illegal"))return{language:p,value:wt(b),illegal:!0,relevance:0,_illegalBy:{message:h.message,index:pe,context:b.slice(pe-100,pe+100),mode:h.mode,resultSoFar:ot},_emitter:D};if(s)return{language:p,value:wt(b),illegal:!1,relevance:0,errorRaised:h,_emitter:D,_top:x};throw h}}function g(p){let b={value:wt(p),illegal:!1,relevance:0,_top:r,_emitter:new l.__emitter(l)};return b._emitter.addText(p),b}function y(p,b){b=b||l.languages||Object.keys(t);let m=g(p),w=b.filter(U).filter(xe).map(j=>d(j,p,!1));w.unshift(m);let S=w.sort((j,ee)=>{if(j.relevance!==ee.relevance)return ee.relevance-j.relevance;if(j.language&&ee.language){if(U(j.language).supersetOf===ee.language)return 1;if(U(ee.language).supersetOf===j.language)return-1}return 0}),[L,H]=S,J=L;return J.secondBest=H,J}function f(p,b,m){let w=b&&n[b]||m;p.classList.add("hljs"),p.classList.add(\`language-\${w}\`)}function E(p){let b=null,m=c(p);if(o(m))return;if(oe("before:highlightElement",{el:p,language:m}),p.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset \`dataset.highlighted\`.",p);return}if(p.children.length>0&&(l.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(p)),l.throwUnescapedHTML))throw new Tt("One of your code blocks includes unescaped HTML.",p.innerHTML);b=p;let w=b.textContent,S=m?u(w,{language:m,ignoreIllegals:!0}):y(w);p.innerHTML=S.value,p.dataset.highlighted="yes",f(p,m,S.language),p.result={language:S.language,re:S.relevance,relevance:S.relevance},S.secondBest&&(p.secondBest={language:S.secondBest.language,relevance:S.secondBest.relevance}),oe("after:highlightElement",{el:p,result:S,text:w})}function C(p){l=Dn(l,p)}let M=()=>{z(),we("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function O(){z(),we("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let $=!1;function z(){function p(){z()}if(document.readyState==="loading"){$||window.addEventListener("DOMContentLoaded",p,!1),$=!0;return}document.querySelectorAll(l.cssSelector).forEach(E)}function I(p,b){let m=null;try{m=b(e)}catch(w){if(be("Language definition for '{}' could not be registered.".replace("{}",p)),s)be(w);else throw w;m=r}m.name||(m.name=p),t[p]=m,m.rawDefinition=b.bind(null,e),m.aliases&&K(m.aliases,{languageName:p})}function N(p){delete t[p];for(let b of Object.keys(n))n[b]===p&&delete n[b]}function de(){return Object.keys(t)}function U(p){return p=(p||"").toLowerCase(),t[p]||t[n[p]]}function K(p,{languageName:b}){typeof p=="string"&&(p=[p]),p.forEach(m=>{n[m.toLowerCase()]=b})}function xe(p){let b=U(p);return b&&!b.disableAutodetect}function Re(p){p["before:highlightBlock"]&&!p["before:highlightElement"]&&(p["before:highlightElement"]=b=>{p["before:highlightBlock"](Object.assign({block:b.el},b))}),p["after:highlightBlock"]&&!p["after:highlightElement"]&&(p["after:highlightElement"]=b=>{p["after:highlightBlock"](Object.assign({block:b.el},b))})}function Ne(p){Re(p),i.push(p)}function Ce(p){let b=i.indexOf(p);b!==-1&&i.splice(b,1)}function oe(p,b){let m=p;i.forEach(function(w){w[m]&&w[m](b)})}function Ie(p){return we("10.7.0","highlightBlock will be removed entirely in v12.0"),we("10.7.0","Please use highlightElement now."),E(p)}Object.assign(e,{highlight:u,highlightAuto:y,highlightAll:z,highlightElement:E,highlightBlock:Ie,configure:C,initHighlighting:M,initHighlightingOnLoad:O,registerLanguage:I,unregisterLanguage:N,listLanguages:de,getLanguage:U,registerAliases:K,autoDetection:xe,inherit:Dn,addPlugin:Ne,removePlugin:Ce}),e.debugMode=function(){s=!1},e.safeMode=function(){s=!0},e.versionString=Sr,e.regex={concat:ke,lookahead:zn,either:At,optional:Hi,anyNumberOfTimes:Ui};for(let p in Qe)typeof Qe[p]=="object"&&Pn(Qe[p]);return Object.assign(e,Qe),e},_e=Wn({});_e.newInstance=()=>Wn({});Xn.exports=_e;_e.HighlightJS=_e;_e.default=_e});var W=null;function dn(e){function t(){W=new WebSocket("ws://"+location.host),W.onopen=function(){e.onOpen()},W.onclose=function(){W=null,e.onClose(),setTimeout(t,2e3)},W.onmessage=function(n){try{let i=JSON.parse(n.data);e.onMessage(i)}catch{}},W.onerror=function(){}}t()}function ge(e){W&&W.readyState===WebSocket.OPEN&&W.send(JSON.stringify(e))}function pn(){return W!==null&&W.readyState===WebSocket.OPEN}function gt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var me=gt();function yn(e){me=e}var he={exec:()=>null};function v(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(s,a)=>{let r=typeof a=="string"?a:a.source;return r=r.replace(q.caret,"$1"),n=n.replace(s,r),i},getRegex:()=>new RegExp(n,t)};return i}var Xs=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),q={codeRemoveIndent:/^(?: {1,4}| {0,3}\\t)/gm,outputLinkReplace:/\\\\([\\[\\]])/g,indentCodeCompensation:/^(\\s+)(?:\`\`\`)/,beginningSpace:/^\\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\\n/g,tabCharGlobal:/\\t/g,multipleSpaceGlobal:/\\s+/g,blankLine:/^[ \\t]*$/,doubleBlankLine:/\\n[ \\t]*\\n[ \\t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\\n {0,3}((?:=+|-+) *)(?=\\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \\t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\\[[ xX]\\] +\\S/,listReplaceTask:/^\\[[ xX]\\] +/,listTaskCheckbox:/\\[[ xX]\\]/,anyLine:/\\n.*\\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\\||\\| *$/g,tableRowBlankLine:/\\n[ \\t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\\s|>)/i,endPreScriptTag:/^<\\/(pre|code|kbd|script)(\\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\\s])\\s+(['"])(.*)\\2/,unicodeAlphaNumeric:/[\\p{L}\\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/g,unescapeTest:/&(#(?:\\d+)|(?:#x[0-9A-Fa-f]+)|(?:\\w+));?/ig,caret:/(^|[^\\[])\\^/g,percentDecode:/%25/g,findPipe:/\\|/g,splitPipe:/ \\|/,slashPipe:/\\\\\\|/g,carriageReturn:/\\r\\n|\\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\\S*/,endingNewline:/\\n$/,listItemRegex:e=>new RegExp(\`^( {0,3}\${e})((?:[	 ][^\\\\n]*)?(?:\\\\n|$))\`),nextBulletRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:[*+-]|\\\\d{1,9}[.)])((?:[ 	][^\\\\n]*)?(?:\\\\n|$))\`),hrRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\\\* *){3,})(?:\\\\n+|$)\`),fencesBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:\\\`\\\`\\\`|~~~)\`),headingBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}#\`),htmlBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}<(?:[a-z].*>|!--)\`,"i"),blockquoteBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}>\`)},Ys=/^(?:[ \\t]*(?:\\n|$))+/,Qs=/^((?: {4}| {0,3}\\t)[^\\n]+(?:\\n(?:[ \\t]*(?:\\n|$))*)?)+/,Vs=/^ {0,3}(\`{3,}(?=[^\`\\n]*(?:\\n|$))|~{3,})([^\\n]*)(?:\\n|$)(?:|([\\s\\S]*?)(?:\\n|$))(?: {0,3}\\1[~\`]* *(?=\\n|$)|$)/,De=/^ {0,3}((?:-[\\t ]*){3,}|(?:_[ \\t]*){3,}|(?:\\*[ \\t]*){3,})(?:\\n+|$)/,Js=/^ {0,3}(#{1,6})(?=\\s|$)(.*)(?:\\n+|$)/,ht=/ {0,3}(?:[*+-]|\\d{1,9}[.)])/,En=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\\n(?!\\s*?\\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,xn=v(En).replace(/bull/g,ht).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/\\|table/g,"").getRegex(),ei=v(En).replace(/bull/g,ht).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/table/g,/ {0,3}\\|?(?:[:\\- ]*\\|)+[\\:\\- ]*\\n/).getRegex(),ft=/^([^\\n]+(?:\\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\\n)[^\\n]+)*)/,ti=/^[^\\n]+/,mt=/(?!\\s*\\])(?:\\\\[\\s\\S]|[^\\[\\]\\\\])+/,ni=v(/^ {0,3}\\[(label)\\]: *(?:\\n[ \\t]*)?([^<\\s][^\\s]*|<.*?>)(?:(?: +(?:\\n[ \\t]*)?| *\\n[ \\t]*)(title))? *(?:\\n+|$)/).replace("label",mt).replace("title",/(?:"(?:\\\\"?|[^"\\\\])*"|'[^'\\n]*(?:\\n[^'\\n]+)*\\n?'|\\([^()]*\\))/).getRegex(),si=v(/^(bull)([ \\t][^\\n]+?)?(?:\\n|$)/).replace(/bull/g,ht).getRegex(),Xe="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",bt=/<!--(?:-?>|[\\s\\S]*?(?:-->|$))/,ii=v("^ {0,3}(?:<(script|pre|style|textarea)[\\\\s>][\\\\s\\\\S]*?(?:</\\\\1>[^\\\\n]*\\\\n+|$)|comment[^\\\\n]*(\\\\n+|$)|<\\\\?[\\\\s\\\\S]*?(?:\\\\?>\\\\n*|$)|<![A-Z][\\\\s\\\\S]*?(?:>\\\\n*|$)|<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?(?:\\\\]\\\\]>\\\\n*|$)|</?(tag)(?: +|\\\\n|/?>)[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|<(?!script|pre|style|textarea)([a-z][\\\\w-]*)(?:attribute)*? */?>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|</(?!script|pre|style|textarea)[a-z][\\\\w-]*\\\\s*>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$))","i").replace("comment",bt).replace("tag",Xe).replace("attribute",/ +[a-zA-Z:_][\\w.:-]*(?: *= *"[^"\\n]*"| *= *'[^'\\n]*'| *= *[^\\s"'=<>\`]+)?/).getRegex(),wn=v(ft).replace("hr",De).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xe).getRegex(),ri=v(/^( {0,3}> ?(paragraph|[^\\n]*)(?:\\n|$))+/).replace("paragraph",wn).getRegex(),kt={blockquote:ri,code:Qs,def:ni,fences:Vs,heading:Js,hr:De,html:ii,lheading:xn,list:si,newline:Ys,paragraph:wn,table:he,text:ti},gn=v("^ *([^\\\\n ].*)\\\\n {0,3}((?:\\\\| *)?:?-+:? *(?:\\\\| *:?-+:? *)*(?:\\\\| *)?)(?:\\\\n((?:(?! *\\\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\\\n|$))*)\\\\n*|$)").replace("hr",De).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\\\n]").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xe).getRegex(),ai={...kt,lheading:ei,table:gn,paragraph:v(ft).replace("hr",De).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("table",gn).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xe).getRegex()},oi={...kt,html:v(\`^ *(?:comment *(?:\\\\n|\\\\s*$)|<(tag)[\\\\s\\\\S]+?</\\\\1> *(?:\\\\n{2,}|\\\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\\\s[^'"/>\\\\s]*)*?/?> *(?:\\\\n{2,}|\\\\s*$))\`).replace("comment",bt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\\\b)\\\\w+(?!:|[^\\\\w\\\\s@]*@)\\\\b").getRegex(),def:/^ *\\[([^\\]]+)\\]: *<?([^\\s>]+)>?(?: +(["(][^\\n]+[")]))? *(?:\\n+|$)/,heading:/^(#{1,6})(.*)(?:\\n+|$)/,fences:he,lheading:/^(.+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,paragraph:v(ft).replace("hr",De).replace("heading",\` *#{1,6} *[^
]\`).replace("lheading",xn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},li=/^\\\\([!"#$%&'()*+,\\-./:;<=>?@\\[\\]\\\\^_\`{|}~])/,ci=/^(\`+)([^\`]|[^\`][\\s\\S]*?[^\`])\\1(?!\`)/,_n=/^( {2,}|\\\\)\\n(?!\\s*$)/,ui=/^(\`+|[^\`])(?:(?= {2,}\\n)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*_]|\\b_|$)|[^ ](?= {2,}\\n)))/,Ye=/[\\p{P}\\p{S}]/u,yt=/[\\s\\p{P}\\p{S}]/u,vn=/[^\\s\\p{P}\\p{S}]/u,di=v(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,yt).getRegex(),Sn=/(?!~)[\\p{P}\\p{S}]/u,pi=/(?!~)[\\s\\p{P}\\p{S}]/u,gi=/(?:[^\\s\\p{P}\\p{S}]|~)/u,Tn=/(?![*_])[\\p{P}\\p{S}]/u,hi=/(?![*_])[\\s\\p{P}\\p{S}]/u,fi=/(?:[^\\s\\p{P}\\p{S}]|[*_])/u,mi=v(/link|precode-code|html/,"g").replace("link",/\\[(?:[^\\[\\]\`]|(?<a>\`+)[^\`]+\\k<a>(?!\`))*?\\]\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)]|\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)])*\\))*\\)/).replace("precode-",Xs?"(?<!\`)()":"(^^|[^\`])").replace("code",/(?<b>\`+)[^\`]+\\k<b>(?!\`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),An=/^(?:\\*+(?:((?!\\*)punct)|[^\\s*]))|^_+(?:((?!_)punct)|([^\\s_]))/,bi=v(An,"u").replace(/punct/g,Ye).getRegex(),ki=v(An,"u").replace(/punct/g,Sn).getRegex(),Rn="^[^_*]*?__[^_*]*?\\\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\\\*)punct(\\\\*+)(?=[\\\\s]|$)|notPunctSpace(\\\\*+)(?!\\\\*)(?=punctSpace|$)|(?!\\\\*)punctSpace(\\\\*+)(?=notPunctSpace)|[\\\\s](\\\\*+)(?!\\\\*)(?=punct)|(?!\\\\*)punct(\\\\*+)(?!\\\\*)(?=punct)|notPunctSpace(\\\\*+)(?=notPunctSpace)",yi=v(Rn,"gu").replace(/notPunctSpace/g,vn).replace(/punctSpace/g,yt).replace(/punct/g,Ye).getRegex(),Ei=v(Rn,"gu").replace(/notPunctSpace/g,gi).replace(/punctSpace/g,pi).replace(/punct/g,Sn).getRegex(),xi=v("^[^_*]*?\\\\*\\\\*[^_*]*?_[^_*]*?(?=\\\\*\\\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,vn).replace(/punctSpace/g,yt).replace(/punct/g,Ye).getRegex(),wi=v(/^~~?(?:((?!~)punct)|[^\\s~])/,"u").replace(/punct/g,Tn).getRegex(),_i="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",vi=v(_i,"gu").replace(/notPunctSpace/g,fi).replace(/punctSpace/g,hi).replace(/punct/g,Tn).getRegex(),Si=v(/\\\\(punct)/,"gu").replace(/punct/g,Ye).getRegex(),Ti=v(/^<(scheme:[^\\s\\x00-\\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_\`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ai=v(bt).replace("(?:-->|$)","-->").getRegex(),Ri=v("^comment|^</[a-zA-Z][\\\\w:-]*\\\\s*>|^<[a-zA-Z][\\\\w-]*(?:attribute)*?\\\\s*/?>|^<\\\\?[\\\\s\\\\S]*?\\\\?>|^<![a-zA-Z]+\\\\s[\\\\s\\\\S]*?>|^<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?\\\\]\\\\]>").replace("comment",Ai).replace("attribute",/\\s+[a-zA-Z:_][\\w.:-]*(?:\\s*=\\s*"[^"]*"|\\s*=\\s*'[^']*'|\\s*=\\s*[^\\s"'=<>\`]+)?/).getRegex(),Ke=/(?:\\[(?:\\\\[\\s\\S]|[^\\[\\]\\\\])*\\]|\\\\[\\s\\S]|\`+[^\`]*?\`+(?!\`)|[^\\[\\]\\\\\`])*?/,Ni=v(/^!?\\[(label)\\]\\(\\s*(href)(?:(?:[ \\t]*(?:\\n[ \\t]*)?)(title))?\\s*\\)/).replace("label",Ke).replace("href",/<(?:\\\\.|[^\\n<>\\\\])+>|[^ \\t\\n\\x00-\\x1f]*/).replace("title",/"(?:\\\\"?|[^"\\\\])*"|'(?:\\\\'?|[^'\\\\])*'|\\((?:\\\\\\)?|[^)\\\\])*\\)/).getRegex(),Nn=v(/^!?\\[(label)\\]\\[(ref)\\]/).replace("label",Ke).replace("ref",mt).getRegex(),Cn=v(/^!?\\[(ref)\\](?:\\[\\])?/).replace("ref",mt).getRegex(),Ci=v("reflink|nolink(?!\\\\()","g").replace("reflink",Nn).replace("nolink",Cn).getRegex(),hn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Et={_backpedal:he,anyPunctuation:Si,autolink:Ti,blockSkip:mi,br:_n,code:ci,del:he,delLDelim:he,delRDelim:he,emStrongLDelim:bi,emStrongRDelimAst:yi,emStrongRDelimUnd:xi,escape:li,link:Ni,nolink:Cn,punctuation:di,reflink:Nn,reflinkSearch:Ci,tag:Ri,text:ui,url:he},Ii={...Et,link:v(/^!?\\[(label)\\]\\((.*?)\\)/).replace("label",Ke).getRegex(),reflink:v(/^!?\\[(label)\\]\\s*\\[([^\\]]*)\\]/).replace("label",Ke).getRegex()},ut={...Et,emStrongRDelimAst:Ei,emStrongLDelim:ki,delLDelim:wi,delRDelim:vi,url:v(/^((?:protocol):\\/\\/|www\\.)(?:[a-zA-Z0-9\\-]+\\.?)+[^\\s<]*|^email/).replace("protocol",hn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\\([^)]*\\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\\s~])((?:\\\\[\\s\\S]|[^\\\\])*?(?:\\\\[\\s\\S]|[^\\s~\\\\]))\\1(?=[^~]|$)/,text:v(/^([\`~]+|[^\`~])(?:(?= {2,}\\n)|(?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*~_]|\\b_|protocol:\\/\\/|www\\.|$)|[^ ](?= {2,}\\n)|[^a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-](?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)))/).replace("protocol",hn).getRegex()},Li={...ut,br:v(_n).replace("{2,}","*").getRegex(),text:v(ut.text).replace("\\\\b_","\\\\b_| {2,}\\\\n").replace(/\\{2,\\}/g,"*").getRegex()},Ze={normal:kt,gfm:ai,pedantic:oi},Le={normal:Et,gfm:ut,breaks:Li,pedantic:Ii},Mi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},fn=e=>Mi[e];function ne(e,t){if(t){if(q.escapeTest.test(e))return e.replace(q.escapeReplace,fn)}else if(q.escapeTestNoEncode.test(e))return e.replace(q.escapeReplaceNoEncode,fn);return e}function mn(e){try{e=encodeURI(e).replace(q.percentDecode,"%")}catch{return null}return e}function bn(e,t){let n=e.replace(q.findPipe,(a,r,l)=>{let o=!1,c=r;for(;--c>=0&&l[c]==="\\\\";)o=!o;return o?"|":" |"}),i=n.split(q.splitPipe),s=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;s<i.length;s++)i[s]=i[s].trim().replace(q.slashPipe,"|");return i}function Me(e,t,n){let i=e.length;if(i===0)return"";let s=0;for(;s<i;){let a=e.charAt(i-s-1);if(a===t&&!n)s++;else if(a!==t&&n)s++;else break}return e.slice(0,i-s)}function Oi(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function Di(e,t=0){let n=t,i="";for(let s of e)if(s==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=s,n++;return i}function kn(e,t,n,i,s){let a=t.href,r=t.title||null,l=e[1].replace(s.other.outputLinkReplace,"$1");i.state.inLink=!0;let o={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:r,text:l,tokens:i.inlineTokens(l)};return i.state.inLink=!1,o}function Bi(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let s=i[1];return t.split(\`
\`).map(a=>{let r=a.match(n.other.beginningSpace);if(r===null)return a;let[l]=r;return l.length>=s.length?a.slice(s.length):a}).join(\`
\`)}var je=class{options;rules;lexer;constructor(e){this.options=e||me}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let n=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:Me(n,\`
...
\`+n.join(\`
\`),E=this.blockquote(f);a[a.length-1]=E,i=i.substring(0,i.length-y.raw.length)+E.raw,s=s.substring(0,s.length-y.text.length)+E.text;break}else if(g?.type==="list"){let y=g,f=y.raw+\`
\`+n.join(\`
\`),E=this.list(f);a[a.length-1]=E,i=i.substring(0,i.length-g.raw.length)+E.raw,s=s.substring(0,s.length-y.raw.length)+E.raw,n=f.substring(a.at(-1).raw.length).split(\`
\`);continue}}return{type:"blockquote",raw:i,tokens:a,text:s}}}list(e){let t=this.rules.block.list.exec(e);if(t){let n=t[1].trim(),i=n.length>1,s={type:"list",raw:"",ordered:i,start:i?+n.slice(0,-1):"",loose:!1,items:[]};n=i?\`\\\\d{1,9}\\\\\${n.slice(-1)}\`:\`\\\\\${n}\`,this.options.pedantic&&(n=i?n:"[*+-]");let a=this.rules.other.listItemRegex(n),r=!1;for(;e;){let o=!1,c="",u="";if(!(t=a.exec(e))||this.rules.block.hr.test(e))break;c=t[0],e=e.substring(c.length);let d=Di(t[2].split(\`
