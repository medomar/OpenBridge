...
// Generated: 2026-03-03T21:45:21.535Z
...
<body>
  ...
  <script>
"use strict";(()=>{var Ys=Object.create;var bn=Object.defineProperty;var Qs=Object.getOwnPropertyDescriptor;var Vs=Object.getOwnPropertyNames;var Js=Object.getPrototypeOf,ei=Object.prototype.hasOwnProperty;var ti=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var ni=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Vs(t))!ei.call(e,s)&&s!==n&&bn(e,s,{get:()=>t[s],enumerable:!(i=Qs(t,s))||i.enumerable});return e};var si=(e,t,n)=>(n=e!=null?Ys(Js(e)):{},ni(t||!e||!e.__esModule?bn(n,"default",{value:e,enumerable:!0}):n,e));var ss=ti((Ka,ns)=>{function qn(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{let n=e[t],i=typeof n;(i==="object"||i==="function")&&!Object.isFrozen(n)&&qn(n)}),e}var nt=class{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function Zn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ce(e,...t){let n=Object.create(null);for(let i in e)n[i]=e[i];return t.forEach(function(i){for(let s in i)n[s]=i[s]}),n}var ji="</span>",$n=e=>!!e.scope,Wi=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let n=e.split(".");return[\`\${t}\${n.shift()}\`,...n.map((i,s)=>\`\${i}\${"_".repeat(s+1)}\`)].join(" ")}return\`\${t}\${e}\`},Ct=class{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=Zn(t)}openNode(t){if(!$n(t))return;let n=Wi(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){$n(t)&&(this.buffer+=ji)}value(){return this.buffer}span(t){this.buffer+=\`<span class="\${t}">\`}},zn=(e={})=>{let t={children:[]};return Object.assign(t,e),t},Nt=class e{constructor(){this.rootNode=zn(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){let n=zn({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(i=>this._walk(t,i)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{e._collapse(n)}))}},It=class extends Nt{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){let i=t.root;n&&(i.scope=\`language:\${n}\`),this.add(i)}toHTML(){return new Ct(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function ze(e){return e?typeof e=="string"?e:e.source:null}function Kn(e){return ye("(?=",e,")")}function Xi(e){return ye("(?:",e,")*")}function Yi(e){return ye("(?:",e,")?")}function ye(...e){return e.map(n=>ze(n)).join("")}function Qi(e){let t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function Mt(...e){return"("+(Qi(e).capture?"":"?:")+e.map(i=>ze(i)).join("|")+")"}function jn(e){return new RegExp(e.toString()+"|").exec("").length-1}function Vi(e,t){let n=e&&e.exec(t);return n&&n.index===0}var Ji=/\\[(?:[^\\\\\\]]|\\\\.)*\\]|\\(\\??|\\\\([1-9][0-9]*)|\\\\./;function Ot(e,{joinWith:t}){let n=0;return e.map(i=>{n+=1;let s=n,a=ze(i),r="";for(;a.length>0;){let l=Ji.exec(a);if(!l){r+=a;break}r+=a.substring(0,l.index),a=a.substring(l.index+l[0].length),l[0][0]==="\\\\"&&l[1]?r+="\\\\"+String(Number(l[1])+s):(r+=l[0],l[0]==="("&&n++)}return r}).map(i=>\`(\${i})\`).join(t)}var er=/\\b\\B/,Wn="[a-zA-Z]\\\\w*",Dt="[a-zA-Z_]\\\\w*",Xn="\\\\b\\\\d+(\\\\.\\\\d+)?",Yn="(-?)(\\\\b0[xX][a-fA-F0-9]+|(\\\\b\\\\d+(\\\\.\\\\d*)?|\\\\.\\\\d+)([eE][-+]?\\\\d+)?)",Qn="\\\\b(0b[01]+)",tr="!|!=|!==|%|%=|&|&&|&=|\\\\*|\\\\*=|\\\\+|\\\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\\\?|\\\\[|\\\\{|\\\\(|\\\\^|\\\\^=|\\\\||\\\\|=|\\\\|\\\\||~",nr=(e={})=>{let t=/^#![ ]*\\//;return e.binary&&(e.begin=ye(t,/.*\\b/,e.binary,/\\b.*/)),ce({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,i)=>{n.index!==0&&i.ignoreMatch()}},e)},Ue={begin:"\\\\\\\\[\\\\s\\\\S]",relevance:0},sr={scope:"string",begin:"'",end:"'",illegal:"\\\\n",contains:[Ue]},ir={scope:"string",begin:'"',end:'"',illegal:"\\\\n",contains:[Ue]},rr={begin:/\\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\\b/},it=function(e,t,n={}){let i=ce({scope:"comment",begin:e,end:t,contains:[]},n);i.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let s=Mt("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return i.contains.push({begin:ye(/[ ]+/,"(",s,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),i},ar=it("//","$"),or=it("/\\\\*","\\\\*/"),lr=it("#","$"),cr={scope:"number",begin:Xn,relevance:0},ur={scope:"number",begin:Yn,relevance:0},dr={scope:"number",begin:Qn,relevance:0},pr={scope:"regexp",begin:/\\/(?=[^/\\n]*\\/)/,end:/\\/[gimuy]*/,contains:[Ue,{begin:/\\[/,end:/\\]/,relevance:0,contains:[Ue]}]},gr={scope:"title",begin:Wn,relevance:0},hr={scope:"title",begin:Dt,relevance:0},fr={begin:"\\\\.\\\\s*"+Dt,relevance:0},mr=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})},tt=Object.freeze({__proto__:null,APOS_STRING_MODE:sr,BACKSLASH_ESCAPE:Ue,BINARY_NUMBER_MODE:dr,BINARY_NUMBER_RE:Qn,COMMENT:it,C_BLOCK_COMMENT_MODE:or,C_LINE_COMMENT_MODE:ar,C_NUMBER_MODE:ur,C_NUMBER_RE:Yn,END_SAME_AS_BEGIN:mr,HASH_COMMENT_MODE:lr,IDENT_RE:Wn,MATCH_NOTHING_RE:er,METHOD_GUARD:fr,NUMBER_MODE:cr,NUMBER_RE:Xn,PHRASAL_WORDS_MODE:rr,QUOTE_STRING_MODE:ir,REGEXP_MODE:pr,RE_STARTERS_RE:tr,SHEBANG:nr,TITLE_MODE:gr,UNDERSCORE_IDENT_RE:Dt,UNDERSCORE_TITLE_MODE:hr});function br(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function kr(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function Er(e,t){t&&e.beginKeywords&&(e.begin="\\\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\\\.)(?=\\\\b|\\\\s)",e.__beforeBegin=br,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function yr(e,t){Array.isArray(e.illegal)&&(e.illegal=Mt(...e.illegal))}function xr(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function wr(e,t){e.relevance===void 0&&(e.relevance=1)}var _r=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let n=Object.assign({},e);Object.keys(e).forEach(i=>{delete e[i]}),e.keywords=n.keywords,e.begin=ye(n.beforeMatch,Kn(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},vr=["of","and","for","in","not","or","if","then","parent","list","value"],Sr="keyword";function Vn(e,t,n=Sr){let i=Object.create(null);return typeof e=="string"?s(n,e.split(" ")):Array.isArray(e)?s(n,e):Object.keys(e).forEach(function(a){Object.assign(i,Vn(e[a],t,a))}),i;function s(a,r){t&&(r=r.map(l=>l.toLowerCase())),r.forEach(function(l){let o=l.split("|");i[o[0]]=[a,Ar(o[0],o[1])]})}}function Ar(e,t){return t?Number(t):Tr(e)?0:1}function Tr(e){return vr.includes(e.toLowerCase())}var Un={},Ee=e=>{console.error(e)},Hn=(e,...t)=>{console.log(\`WARN: \${e}\`,...t)},ve=(e,t)=>{Un[\`\${e}/\${t}\`]||(console.log(\`Deprecated as of \${e}. \${t}\`),Un[\`\${e}/\${t}\`]=!0)},st=new Error;function Jn(e,t,{key:n}){let i=0,s=e[n],a={},r={};for(let l=1;l<=t.length;l++)r[l+i]=s[l],a[l+i]=!0,i+=jn(t[l-1]);e[n]=r,e[n]._emit=a,e[n]._multi=!0}function Rr(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw Ee("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),st;if(typeof e.beginScope!="object"||e.beginScope===null)throw Ee("beginScope must be object"),st;Jn(e,e.begin,{key:"beginScope"}),e.begin=Ot(e.begin,{joinWith:""})}}function Cr(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw Ee("skip, excludeEnd, returnEnd not compatible with endScope: {}"),st;if(typeof e.endScope!="object"||e.endScope===null)throw Ee("endScope must be object"),st;Jn(e,e.end,{key:"endScope"}),e.end=Ot(e.end,{joinWith:""})}}function Nr(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function Ir(e){Nr(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),Rr(e),Cr(e)}function Lr(e){function t(r,l){return new RegExp(ze(r),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(l?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(l,o){o.position=this.position++,this.matchIndexes[this.matchAt]=o,this.regexes.push([o,l]),this.matchAt+=jn(l)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let l=this.regexes.map(o=>o[1]);this.matcherRe=t(Ot(l,{joinWith:"|"}),!0),this.lastIndex=0}exec(l){this.matcherRe.lastIndex=this.lastIndex;let o=this.matcherRe.exec(l);if(!o)return null;let c=o.findIndex((d,g)=>g>0&&d!==void 0),u=this.matchIndexes[c];return o.splice(0,c),Object.assign(o,u)}}class i{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(l){if(this.multiRegexes[l])return this.multiRegexes[l];let o=new n;return this.rules.slice(l).forEach(([c,u])=>o.addRule(c,u)),o.compile(),this.multiRegexes[l]=o,o}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(l,o){this.rules.push([l,o]),o.type==="begin"&&this.count++}exec(l){let o=this.getMatcher(this.regexIndex);o.lastIndex=this.lastIndex;let c=o.exec(l);if(this.resumingScanAtSamePosition()&&!(c&&c.index===this.lastIndex)){let u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,c=u.exec(l)}return c&&(this.regexIndex+=c.position+1,this.regexIndex===this.count&&this.considerAll()),c}}function s(r){let l=new i;return r.contains.forEach(o=>l.addRule(o.begin,{rule:o,type:"begin"})),r.terminatorEnd&&l.addRule(r.terminatorEnd,{type:"end"}),r.illegal&&l.addRule(r.illegal,{type:"illegal"}),l}function a(r,l){let o=r;if(r.isCompiled)return o;[kr,xr,Ir,_r].forEach(u=>u(r,l)),e.compilerExtensions.forEach(u=>u(r,l)),r.__beforeBegin=null,[Er,yr,wr].forEach(u=>u(r,l)),r.isCompiled=!0;let c=null;return typeof r.keywords=="object"&&r.keywords.$pattern&&(r.keywords=Object.assign({},r.keywords),c=r.keywords.$pattern,delete r.keywords.$pattern),c=c||/\\w+/,r.keywords&&(r.keywords=Vn(r.keywords,e.case_insensitive)),o.keywordPatternRe=t(c,!0),l&&(r.begin||(r.begin=/\\B|\\b/),o.beginRe=t(o.begin),!r.end&&!r.endsWithParent&&(r.end=/\\B|\\b/),r.end&&(o.endRe=t(o.end)),o.terminatorEnd=ze(o.end)||"",r.endsWithParent&&l.terminatorEnd&&(o.terminatorEnd+=(r.end?"|":"")+l.terminatorEnd)),r.illegal&&(o.illegalRe=t(r.illegal)),r.contains||(r.contains=[]),r.contains=[].concat(...r.contains.map(function(u){return Mr(u==="self"?r:u)})),r.contains.forEach(function(u){a(u,o)}),r.starts&&a(r.starts,l),o.matcher=s(o),o}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains \`self\` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=ce(e.classNameAliases||{}),a(e)}function es(e){return e?e.endsWithParent||es(e.starts):!1}function Mr(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return ce(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:es(e)?ce(e,{starts:e.starts?ce(e.starts):null}):Object.isFrozen(e)?ce(e):e}var Or="11.11.1",Lt=class extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}},Rt=Zn,Fn=ce,Gn=Symbol("nomatch"),Dr=7,ts=function(e){let t=Object.create(null),n=Object.create(null),i=[],s=!0,a="Could not find the language '{}', did you forget to load/include a language module?",r={disableAutodetect:!0,name:"Plain text",contains:[]},l={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\\blang(?:uage)?-([\\w-]+)\\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:It};function o(p){return l.noHighlightRe.test(p)}function c(p){let b=p.className+" ";b+=p.parentNode?p.parentNode.className:"";let m=l.languageDetectRe.exec(b);if(m){let w=U(m[1]);return w||(Hn(a.replace("{}",m[1])),Hn("Falling back to no-highlight mode for this block.",p)),w?m[1]:"no-highlight"}return b.split(/\\s+/).find(w=>o(w)||U(w))}function u(p,b,m){let w="",S="";typeof b=="object"?(w=p,m=b.ignoreIllegals,S=b.language):(ve("10.7.0","highlight(lang, code, ...args) has been deprecated."),ve("10.7.0",\`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277\`),S=p,w=b),m===void 0&&(m=!0);let L={code:w,language:S};le("before:highlight",L);let H=L.result?L.result:d(L.language,L.code,m);return H.code=L.code,le("after:highlight",H),H}function d(p,b,m,w){let S=Object.create(null);function L(h,k){return h.keywords[k]}function H(){if(!x.keywords){D.addText(R);return}let h=0;x.keywordPatternRe.lastIndex=0;let k=x.keywordPatternRe.exec(R),_="";for(;k;){_+=R.substring(h,k.index);let T=te.case_insensitive?k[0].toLowerCase():k[0],F=L(x,T);if(F){let[ie,Ws]=F;if(D.addText(_),_="",S[T]=(S[T]||0)+1,S[T]<=Dr&&(We+=Ws),ie.startsWith("_"))_+=k[0];else{let Xs=te.classNameAliases[ie]||ie;ee(k[0],Xs)}}else _+=k[0];h=x.keywordPatternRe.lastIndex,k=x.keywordPatternRe.exec(R)}_+=R.substring(h),D.addText(_)}function J(){if(R==="")return;let h=null;if(typeof x.subLanguage=="string"){if(!t[x.subLanguage]){D.addText(R);return}h=d(x.subLanguage,R,!0,mn[x.subLanguage]),mn[x.subLanguage]=h._top}else h=E(R,x.subLanguage.length?x.subLanguage:null);x.relevance>0&&(We+=h.relevance),D.__addSublanguage(h._emitter,h.language)}function j(){x.subLanguage!=null?J():H(),R=""}function ee(h,k){h!==""&&(D.startScope(k),D.addText(h),D.endScope())}function pn(h,k){let _=1,T=k.length-1;for(;_<=T;){if(!h._emit[_]){_++;continue}let F=te.classNameAliases[h[_]]||h[_],ie=k[_];F?ee(ie,F):(R=ie,H(),R=""),_++}}function gn(h,k){return h.scope&&typeof h.scope=="string"&&D.openNode(te.classNameAliases[h.scope]||h.scope),h.beginScope&&(h.beginScope._wrap?(ee(R,te.classNameAliases[h.beginScope._wrap]||h.beginScope._wrap),R=""):h.beginScope._multi&&(pn(h.beginScope,k),R="")),x=Object.create(h,{parent:{value:x}}),x}function hn(h,k,_){let T=Vi(h.endRe,_);if(T){if(h["on:end"]){let F=new nt(h);h["on:end"](k,F),F.isMatchIgnored&&(T=!1)}if(T){for(;h.endsParent&&h.parent;)h=h.parent;return h}}if(h.endsWithParent)return hn(h.parent,k,_)}function Gs(h){return x.matcher.regexIndex===0?(R+=h[0],1):(ft=!0,0)}function qs(h){let k=h[0],_=h.rule,T=new nt(_),F=[_.__beforeBegin,_["on:begin"]];for(let ie of F)if(ie&&(ie(h,T),T.isMatchIgnored))return Gs(k);return _.skip?R+=k:(_.excludeBegin&&(R+=k),j(),!_.returnBegin&&!_.excludeBegin&&(R=k)),gn(_,h),_.returnBegin?0:k.length}function Zs(h){let k=h[0],_=b.substring(h.index),T=hn(x,h,_);if(!T)return Gn;let F=x;x.endScope&&x.endScope._wrap?(j(),ee(k,x.endScope._wrap)):x.endScope&&x.endScope._multi?(j(),pn(x.endScope,h)):F.skip?R+=k:(F.returnEnd||F.excludeEnd||(R+=k),j(),F.excludeEnd&&(R=k));do x.scope&&D.closeNode(),!x.skip&&!x.subLanguage&&(We+=x.relevance),x=x.parent;while(x!==T.parent);return T.starts&&gn(T.starts,h),F.returnEnd?0:k.length}function Ks(){let h=[];for(let k=x;k!==te;k=k.parent)k.scope&&h.unshift(k.scope);h.forEach(k=>D.openNode(k))}let je={};function fn(h,k){let _=k&&k[0];if(R+=h,_==null)return j(),0;if(je.type==="begin"&&k.type==="end"&&je.index===k.index&&_===""){if(R+=b.slice(k.index,k.index+1),!s){let T=new Error(\`0 width match regex (\${p})\`);throw T.languageName=p,T.badRule=je.rule,T}return 1}if(je=k,k.type==="begin")return qs(k);if(k.type==="illegal"&&!m){let T=new Error('Illegal lexeme "'+_+'" for mode "'+(x.scope||"<unnamed>")+'"');throw T.mode=x,T}else if(k.type==="end"){let T=Zs(k);if(T!==Gn)return T}if(k.type==="illegal"&&_==="")return R+=\`
\`,1;if(ht>1e5&&ht>k.index*3)throw new Error("potential infinite loop, way more iterations than matches");return R+=_,_.length}let te=U(p);if(!te)throw Ee(a.replace("{}",p)),new Error('Unknown language: "'+p+'"');let js=Lr(te),gt="",x=w||js,mn={},D=new l.__emitter(l);Ks();let R="",We=0,he=0,ht=0,ft=!1;try{if(te.__emitTokens)te.__emitTokens(b,D);else{for(x.matcher.considerAll();;){ht++,ft?ft=!1:x.matcher.considerAll(),x.matcher.lastIndex=he;let h=x.matcher.exec(b);if(!h)break;let k=b.substring(he,h.index),_=fn(k,h);he=h.index+_}fn(b.substring(he))}return D.finalize(),gt=D.toHTML(),{language:p,value:gt,relevance:We,illegal:!1,_emitter:D,_top:x}}catch(h){if(h.message&&h.message.includes("Illegal"))return{language:p,value:Rt(b),illegal:!0,relevance:0,_illegalBy:{message:h.message,index:he,context:b.slice(he-100,he+100),mode:h.mode,resultSoFar:gt},_emitter:D};if(s)return{language:p,value:Rt(b),illegal:!1,relevance:0,errorRaised:h,_emitter:D,_top:x};throw h}}function g(p){let b={value:Rt(p),illegal:!1,relevance:0,_top:r,_emitter:new l.__emitter(l)};return b._emitter.addText(p),b}function E(p,b){b=b||l.languages||Object.keys(t);let m=g(p),w=b.filter(U).filter(_e).map(j=>d(j,p,!1));w.unshift(m);let S=w.sort((j,ee)=>{if(j.relevance!==ee.relevance)return ee.relevance-j.relevance;if(j.language&&ee.language){if(U(j.language).supersetOf===ee.language)return 1;if(U(ee.language).supersetOf===j.language)return-1}return 0}),[L,H]=S,J=L;return J.secondBest=H,J}function f(p,b,m){let w=b&&n[b]||m;p.classList.add("hljs"),p.classList.add(\`language-\${w}\`)}function y(p){let b=null,m=c(p);if(o(m))return;if(le("before:highlightElement",{el:p,language:m}),p.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset \`dataset.highlighted\`.",p);return}if(p.children.length>0&&(l.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(p)),l.throwUnescapedHTML))throw new Lt("One of your code blocks includes unescaped HTML.",p.innerHTML);b=p;let w=b.textContent,S=m?u(w,{language:m,ignoreIllegals:!0}):E(w);p.innerHTML=S.value,p.dataset.highlighted="yes",f(p,m,S.language),p.result={language:S.language,re:S.relevance,relevance:S.relevance},S.secondBest&&(p.secondBest={language:S.secondBest.language,relevance:S.secondBest.relevance}),le("after:highlightElement",{el:p,result:S,text:w})}function N(p){l=Fn(l,p)}let M=()=>{z(),ve("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function O(){z(),ve("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let $=!1;function z(){function p(){z()}if(document.readyState==="loading"){$||window.addEventListener("DOMContentLoaded",p,!1),$=!0;return}document.querySelectorAll(l.cssSelector).forEach(y)}function I(p,b){let m=null;try{m=b(e)}catch(w){if(Ee("Language definition for '{}' could not be registered.".replace("{}",p)),s)Ee(w);else throw w;m=r}m.name||(m.name=p),t[p]=m,m.rawDefinition=b.bind(null,e),m.aliases&&K(m.aliases,{languageName:p})}function C(p){delete t[p];for(let b of Object.keys(n))n[b]===p&&delete n[b]}function ge(){return Object.keys(t)}function U(p){return p=(p||"").toLowerCase(),t[p]||t[n[p]]}function K(p,{languageName:b}){typeof p=="string"&&(p=[p]),p.forEach(m=>{n[m.toLowerCase()]=b})}function _e(p){let b=U(p);return b&&!b.disableAutodetect}function Ie(p){p["before:highlightBlock"]&&!p["before:highlightElement"]&&(p["before:highlightElement"]=b=>{p["before:highlightBlock"](Object.assign({block:b.el},b))}),p["after:highlightBlock"]&&!p["after:highlightElement"]&&(p["after:highlightElement"]=b=>{p["after:highlightBlock"](Object.assign({block:b.el},b))})}function Le(p){Ie(p),i.push(p)}function Me(p){let b=i.indexOf(p);b!==-1&&i.splice(b,1)}function le(p,b){let m=p;i.forEach(function(w){w[m]&&w[m](b)})}function Oe(p){return ve("10.7.0","highlightBlock will be removed entirely in v12.0"),ve("10.7.0","Please use highlightElement now."),y(p)}Object.assign(e,{highlight:u,highlightAuto:E,highlightAll:z,highlightElement:y,highlightBlock:Oe,configure:N,initHighlighting:M,initHighlightingOnLoad:O,registerLanguage:I,unregisterLanguage:C,listLanguages:ge,getLanguage:U,registerAliases:K,autoDetection:_e,inherit:Fn,addPlugin:Le,removePlugin:Me}),e.debugMode=function(){s=!1},e.safeMode=function(){s=!0},e.versionString=Or,e.regex={concat:ye,lookahead:Kn,either:Mt,optional:Yi,anyNumberOfTimes:Xi};for(let p in tt)typeof tt[p]=="object"&&qn(tt[p]);return Object.assign(e,tt),e},Se=ts({});Se.newInstance=()=>ts({});ns.exports=Se;Se.HighlightJS=Se;Se.default=Se});var W=null;function kn(e){function t(){W=new WebSocket("ws://"+location.host),W.onopen=function(){e.onOpen()},W.onclose=function(){W=null,e.onClose(),setTimeout(t,2e3)},W.onmessage=function(n){try{let i=JSON.parse(n.data);e.onMessage(i)}catch{}},W.onerror=function(){}}t()}function fe(e){W&&W.readyState===WebSocket.OPEN&&W.send(JSON.stringify(e))}function En(){return W!==null&&W.readyState===WebSocket.OPEN}function Et(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ke=Et();function An(e){ke=e}var me={exec:()=>null};function v(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(s,a)=>{let r=typeof a=="string"?a:a.source;return r=r.replace(q.caret,"$1"),n=n.replace(s,r),i},getRegex:()=>new RegExp(n,t)};return i}var ii=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),q={codeRemoveIndent:/^(?: {1,4}| {0,3}\\t)/gm,outputLinkReplace:/\\\\([\\[\\]])/g,indentCodeCompensation:/^(\\s+)(?:\`\`\`)/,beginningSpace:/^\\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\\n/g,tabCharGlobal:/\\t/g,multipleSpaceGlobal:/\\s+/g,blankLine:/^[ \\t]*$/,doubleBlankLine:/\\n[ \\t]*\\n[ \\t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\\n {0,3}((?:=+|-+) *)(?=\\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \\t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\\[[ xX]\\] +\\S/,listReplaceTask:/^\\[[ xX]\\] +/,listTaskCheckbox:/\\[[ xX]\\]/,anyLine:/\\n.*\\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\\||\\| *$/g,tableRowBlankLine:/\\n[ \\t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\\s|>)/i,endPreScriptTag:/^<\\/(pre|code|kbd|script)(\\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\\s])\\s+(['"])(.*)\\2/,unicodeAlphaNumeric:/[\\p{L}\\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/g,unescapeTest:/&(#(?:\\d+)|(?:#x[0-9A-Fa-f]+)|(?:\\w+));?/ig,caret:/(^|[^\\[])\\^/g,percentDecode:/%25/g,findPipe:/\\|/g,splitPipe:/ \\|/,slashPipe:/\\\\\\|/g,carriageReturn:/\\r\\n|\\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\\S*/,endingNewline:/\\n$/,listItemRegex:e=>new RegExp(\`^( {0,3}\${e})((?:[	 ][^\\\\n]*)?(?:\\\\n|$))\`),nextBulletRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:[*+-]|\\\\d{1,9}[.)])((?:[ 	][^\\\\n]*)?(?:\\\\n|$))\`),hrRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\\\* *){3,})(?:\\\\n+|$)\`),fencesBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:\\\`\\\`\\\`|~~~)\`),headingBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}#\`),htmlBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}<(?:[a-z].*>|!--)\`,"i"),blockquoteBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}>\`)},ri=/^(?:[ \\t]*(?:\\n|$))+/,ai=/^((?: {4}| {0,3}\\t)[^\\n]+(?:\\n(?:[ \\t]*(?:\\n|$))*)?)+/,oi=/^ {0,3}(\`{3,}(?=[^\`\\n]*(?:\\n|$))|~{3,})([^\\n]*)(?:\\n|$)(?:|([\\s\\S]*?)(?:\\n|$))(?: {0,3}\\1[~\`]* *(?=\\n|$)|$)/,$e=/^ {0,3}((?:-[\\t ]*){3,}|(?:_[ \\t]*){3,}|(?:\\*[ \\t]*){3,})(?:\\n+|$)/,li=/^ {0,3}(#{1,6})(?=\\s|$)(.*)(?:\\n+|$)/,yt=/ {0,3}(?:[*+-]|\\d{1,9}[.)])/,Tn=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\\n(?!\\s*?\\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,Rn=v(Tn).replace(/bull/g,yt).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/\\|table/g,"").getRegex(),ci=v(Tn).replace(/bull/g,yt).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/table/g,/ {0,3}\\|?(?:[:\\- ]*\\|)+[\\:\\- ]*\\n/).getRegex(),xt=/^([^\\n]+(?:\\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\\n)[^\\n]+)*)/,ui=/^[^\\n]+/,wt=/(?!\\s*\\])(?:\\\\[\\s\\S]|[^\\[\\]\\\\])+/,di=v(/^ {0,3}\\[(label)\\]: *(?:\\n[ \\t]*)?([^<\\s][^\\s]*|<.*?>)(?:(?: +(?:\\n[ \\t]*)?| *\\n[ \\t]*)(title))? *(?:\\n+|$)/).replace("label",wt).replace("title",/(?:"(?:\\\\"?|[^"\\\\])*"|'[^'\\n]*(?:\\n[^'\\n]+)*\\n?'|\\([^()]*\\))/).getRegex(),pi=v(/^(bull)([ \\t][^\\n]+?)?(?:\\n|$)/).replace(/bull/g,yt).getRegex(),Je="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",_t=/<!--(?:-?>|[\\s\\S]*?(?:-->|$))/,gi=v("^ {0,3}(?:<(script|pre|style|textarea)[\\\\s>][\\\\s\\\\S]*?(?:</\\\\1>[^\\\\n]*\\\\n+|$)|comment[^\\\\n]*(\\\\n+|$)|<\\\\?[\\\\s\\\\S]*?(?:\\\\?>\\\\n*|$)|<![A-Z][\\\\s\\\\S]*?(?:>\\\\n*|$)|<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?(?:\\\\]\\\\]>\\\\n*|$)|</?(tag)(?: +|\\\\n|/?>)[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|<(?!script|pre|style|textarea)([a-z][\\\\w-]*)(?:attribute)*? */?>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|</(?!script|pre|style|textarea)[a-z][\\\\w-]*\\\\s*>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$))","i").replace("comment",_t).replace("tag",Je).replace("attribute",/ +[a-zA-Z:_][\\w.:-]*(?: *= *"[^"\\n]*"| *= *'[^'\\n]*'| *= *[^\\s"'=<>\`]+)?/).getRegex(),Cn=v(xt).replace("hr",$e).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Je).getRegex(),hi=v(/^( {0,3}> ?(paragraph|[^\\n]*)(?:\\n|$))+/).replace("paragraph",Cn).getRegex(),vt={blockquote:hi,code:ai,def:di,fences:oi,heading:li,hr:$e,html:gi,lheading:Rn,list:pi,newline:ri,paragraph:Cn,table:me,text:ui},yn=v("^ *([^\\\\n ].*)\\\\n {0,3}((?:\\\\| *)?:?-+:? *(?:\\\\| *:?-+:? *)*(?:\\\\| *)?)(?:\\\\n((?:(?! *\\\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\\\n|$))*)\\\\n*|$)").replace("hr",$e).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\\\n]").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Je).getRegex(),fi={...vt,lheading:ci,table:yn,paragraph:v(xt).replace("hr",$e).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("table",yn).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Je).getRegex()},mi={...vt,html:v(\`^ *(?:comment *(?:\\\\n|\\\\s*$)|<(tag)[\\\\s\\\\S]+?</\\\\1> *(?:\\\\n{2,}|\\\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\\\s[^'"/>\\\\s]*)*?/?> *(?:\\\\n{2,}|\\\\s*$))\`).replace("comment",_t).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\\\b)\\\\w+(?!:|[^\\\\w\\\\s@]*@)\\\\b").getRegex(),def:/^ *\\[([^\\]]+)\\]: *<?([^\\s>]+)>?(?: +(["(][^\\n]+[")]))? *(?:\\n+|$)/,heading:/^(#{1,6})(.*)(?:\\n+|$)/,fences:me,lheading:/^(.+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,paragraph:v(xt).replace("hr",$e).replace("heading",\` *#{1,6} *[^
]\`).replace("lheading",Rn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},bi=/^\\\\([!"#$%&'()*+,\\-./:;<=>?@\\[\\]\\\\^_\`{|}~])/,ki=/^(\`+)([^\`]|[^\`][\\s\\S]*?[^\`])\\1(?!\`)/,Nn=/^( {2,}|\\\\)\\n(?!\\s*$)/,Ei=/^(\`+|[^\`])(?:(?= {2,}\\n)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*_]|\\b_|$)|[^ ](?= {2,}\\n)))/,et=/[\\p{P}\\p{S}]/u,St=/[\\s\\p{P}\\p{S}]/u,In=/[^\\s\\p{P}\\p{S}]/u,yi=v(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,St).getRegex(),Ln=/(?!~)[\\p{P}\\p{S}]/u,xi=/(?!~)[\\s\\p{P}\\p{S}]/u,wi=/(?:[^\\s\\p{P}\\p{S}]|~)/u,Mn=/(?![*_])[\\p{P}\\p{S}]/u,_i=/(?![*_])[\\s\\p{P}\\p{S}]/u,vi=/(?:[^\\s\\p{P}\\p{S}]|[*_])/u,Si=v(/link|precode-code|html/,"g").replace("link",/\\[(?:[^\\[\\]\`]|(?<a>\`+)[^\`]+\\k<a>(?!\`))*?\\]\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)]|\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)])*\\))*\\)/).replace("precode-",ii?"(?<!\`)()":"(^^|[^\`])").replace("code",/(?<b>\`+)[^\`]+\\k<b>(?!\`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),On=/^(?:\\*+(?:((?!\\*)punct)|[^\\s*]))|^_+(?:((?!_)punct)|([^\\s_]))/,Ai=v(On,"u").replace(/punct/g,et).getRegex(),Ti=v(On,"u").replace(/punct/g,Ln).getRegex(),Dn="^[^_*]*?__[^_*]*?\\\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\\\*)punct(\\\\*+)(?=[\\\\s]|$)|notPunctSpace(\\\\*+)(?!\\\\*)(?=punctSpace|$)|(?!\\\\*)punctSpace(\\\\*+)(?=notPunctSpace)|[\\\\s](\\\\*+)(?!\\\\*)(?=punct)|(?!\\\\*)punct(\\\\*+)(?!\\\\*)(?=punct)|notPunctSpace(\\\\*+)(?=notPunctSpace)",Ri=v(Dn,"gu").replace(/notPunctSpace/g,In).replace(/punctSpace/g,St).replace(/punct/g,et).getRegex(),Ci=v(Dn,"gu").replace(/notPunctSpace/g,wi).replace(/punctSpace/g,xi).replace(/punct/g,Ln).getRegex(),Ni=v("^[^_*]*?\\\\*\\\\*[^_*]*?_[^_*]*?(?=\\\\*\\\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,In).replace(/punctSpace/g,St).replace(/punct/g,et).getRegex(),Ii=v(/^~~?(?:((?!~)punct)|[^\\s~])/,"u").replace(/punct/g,Mn).getRegex(),Li="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Mi=v(Li,"gu").replace(/notPunctSpace/g,vi).replace(/punctSpace/g,_i).replace(/punct/g,Mn).getRegex(),Oi=v(/\\\\(punct)/,"gu").replace(/punct/g,et).getRegex(),Di=v(/^<(scheme:[^\\s\\x00-\\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_\`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Bi=v(_t).replace("(?:-->|$)","-->").getRegex(),Pi=v("^comment|^</[a-zA-Z][\\\\w:-]*\\\\s*>|^<[a-zA-Z][\\\\w-]*(?:attribute)*?\\\\s*/?>|^<\\\\?[\\\\s\\\\S]*?\\\\?>|^<![a-zA-Z]+\\\\s[\\\\s\\\\S]*?>|^<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?\\\\]\\\\]>").replace("comment",Bi).replace("attribute",/\\s+[a-zA-Z:_][\\w.:-]*(?:\\s*=\\s*"[^"]*"|\\s*=\\s*'[^']*'|\\s*=\\s*[^\\s"'=<>\`]+)?/).getRegex(),Ye=/(?:\\[(?:\\\\[\\s\\S]|[^\\[\\]\\\\])*\\]|\\\\[\\s\\S]|\`+[^\`]*?\`+(?!\`)|[^\\[\\]\\\\\`])*?/,$i=v(/^!?\\[(label)\\]\\(\\s*(href)(?:(?:[ \\t]*(?:\\n[ \\t]*)?)(title))?\\s*\\)/).replace("label",Ye).replace("href",/<(?:\\\\.|[^\\n<>\\\\])+>|[^ \\t\\n\\x00-\\x1f]*/).replace("title",/"(?:\\\\"?|[^"\\\\])*"|'(?:\\\\'?|[^'\\\\])*'|\\((?:\\\\\\)?|[^)\\\\])*\\)/).getRegex(),Bn=v(/^!?\\[(label)\\]\\[(ref)\\]/).replace("label",Ye).replace("ref",wt).getRegex(),Pn=v(/^!?\\[(ref)\\](?:\\[\\])?/).replace("ref",wt).getRegex(),zi=v("reflink|nolink(?!\\\\()","g").replace("reflink",Bn).replace("nolink",Pn).getRegex(),xn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,At={_backpedal:me,anyPunctuation:Oi,autolink:Di,blockSkip:Si,br:Nn,code:ki,del:me,delLDelim:me,delRDelim:me,emStrongLDelim:Ai,emStrongRDelimAst:Ri,emStrongRDelimUnd:Ni,escape:bi,link:$i,nolink:Pn,punctuation:yi,reflink:Bn,reflinkSearch:zi,tag:Pi,text:Ei,url:me},Ui={...At,link:v(/^!?\\[(label)\\]\\((.*?)\\)/).replace("label",Ye).getRegex(),reflink:v(/^!?\\[(label)\\]\\s*\\[([^\\]]*)\\]/).replace("label",Ye).getRegex()},mt={...At,emStrongRDelimAst:Ci,emStrongLDelim:Ti,delLDelim:Ii,delRDelim:Mi,url:v(/^((?:protocol):\\/\\/|www\\.)(?:[a-zA-Z0-9\\-]+\\.?)+[^\\s<]*|^email/).replace("protocol",xn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\\([^)]*\\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\\s~])((?:\\\\[\\s\\S]|[^\\\\])*?(?:\\\\[\\s\\S]|[^\\s~\\\\]))\\1(?=[^~]|$)/,text:v(/^([\`~]+|[^\`~])(?:(?= {2,}\\n)|(?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*~_]|\\b_|protocol:\\/\\/|www\\.|$)|[^ ](?= {2,}\\n)|[^a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-](?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)))/).replace("protocol",xn).getRegex()},Hi={...mt,br:v(Nn).replace("{2,}","*").getRegex(),text:v(mt.text).replace("\\\\b_","\\\\b_| {2,}\\\\n").replace(/\\{2,\\}/g,"*").getRegex()},Xe={normal:vt,gfm:fi,pedantic:mi},De={normal:At,gfm:mt,breaks:Hi,pedantic:Ui},Fi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},wn=e=>Fi[e];function ne(e,t){if(t){if(q.escapeTest.test(e))return e.replace(q.escapeReplace,wn)}else if(q.escapeTestNoEncode.test(e))return e.replace(q.escapeReplaceNoEncode,wn);return e}function _n(e){try{e=encodeURI(e).replace(q.percentDecode,"%")}catch{return null}return e}function vn(e,t){let n=e.replace(q.findPipe,(a,r,l)=>{let o=!1,c=r;for(;--c>=0&&l[c]==="\\\\";)o=!o;return o?"|":" |"}),i=n.split(q.splitPipe),s=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;s<i.length;s++)i[s]=i[s].trim().replace(q.slashPipe,"|");return i}function Be(e,t,n){let i=e.length;if(i===0)return"";let s=0;for(;s<i;){let a=e.charAt(i-s-1);if(a===t&&!n)s++;else if(a!==t&&n)s++;else break}return e.slice(0,i-s)}function Gi(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function qi(e,t=0){let n=t,i="";for(let s of e)if(s==="	"){let a=4-n%4;i+=" ".repeat(a),n+=a}else i+=s,n++;return i}function Sn(e,t,n,i,s){let a=t.href,r=t.title||null,l=e[1].replace(s.other.outputLinkReplace,"$1");i.state.inLink=!0;let o={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:r,text:l,tokens:i.inlineTokens(l)};return i.state.inLink=!1,o}function Zi(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let s=i[1];return t.split(\`
\`).map(a=>{let r=a.match(n.other.beginningSpace);if(r===null)return a;let[l]=r;return l.length>=s.length?a.slice(s.length):a}).join(\`
\`)}var Qe=class{options;rules;lexer;constructor(e){this.options=e||ke}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let n=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:Be(n,\`
