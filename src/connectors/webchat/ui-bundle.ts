...
// Generated: 2026-03-03T20:31:04.175Z
...
<body>
  ...
  <script>
"use strict";(()=>{var Rs=Object.create;var Jt=Object.defineProperty;var Ns=Object.getOwnPropertyDescriptor;var Cs=Object.getOwnPropertyNames;var Is=Object.getPrototypeOf,Ms=Object.prototype.hasOwnProperty;var Os=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Ls=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Cs(t))!Ms.call(e,s)&&s!==n&&Jt(e,s,{get:()=>t[s],enumerable:!(r=Ns(t,s))||r.enumerable});return e};var Ds=(e,t,n)=>(n=e!=null?Rs(Is(e)):{},Ls(t||!e||!e.__esModule?Jt(n,"default",{value:e,enumerable:!0}):n,e));var Un=Os((ga,zn)=>{function Tn(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{let n=e[t],r=typeof n;(r==="object"||r==="function")&&!Object.isFrozen(n)&&Tn(n)}),e}var Ye=class{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function Rn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ae(e,...t){let n=Object.create(null);for(let r in e)n[r]=e[r];return t.forEach(function(r){for(let s in r)n[s]=r[s]}),n}var vr="</span>",yn=e=>!!e.scope,Ar=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let n=e.split(".");return[\`\${t}\${n.shift()}\`,...n.map((r,s)=>\`\${r}\${"_".repeat(s+1)}\`)].join(" ")}return\`\${t}\${e}\`},Et=class{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=Rn(t)}openNode(t){if(!yn(t))return;let n=Ar(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){yn(t)&&(this.buffer+=vr)}value(){return this.buffer}span(t){this.buffer+=\`<span class="\${t}">\`}},wn=(e={})=>{let t={children:[]};return Object.assign(t,e),t},xt=class e{constructor(){this.rootNode=wn(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){let n=wn({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(r=>this._walk(t,r)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{e._collapse(n)}))}},yt=class extends xt{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){let r=t.root;n&&(r.scope=\`language:\${n}\`),this.add(r)}toHTML(){return new Et(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function Le(e){return e?typeof e=="string"?e:e.source:null}function Nn(e){return be("(?=",e,")")}function Tr(e){return be("(?:",e,")*")}function Rr(e){return be("(?:",e,")?")}function be(...e){return e.map(n=>Le(n)).join("")}function Nr(e){let t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function _t(...e){return"("+(Nr(e).capture?"":"?:")+e.map(r=>Le(r)).join("|")+")"}function Cn(e){return new RegExp(e.toString()+"|").exec("").length-1}function Cr(e,t){let n=e&&e.exec(t);return n&&n.index===0}var Ir=/\\[(?:[^\\\\\\]]|\\\\.)*\\]|\\(\\??|\\\\([1-9][0-9]*)|\\\\./;function St(e,{joinWith:t}){let n=0;return e.map(r=>{n+=1;let s=n,a=Le(r),i="";for(;a.length>0;){let l=Ir.exec(a);if(!l){i+=a;break}i+=a.substring(0,l.index),a=a.substring(l.index+l[0].length),l[0][0]==="\\\\"&&l[1]?i+="\\\\"+String(Number(l[1])+s):(i+=l[0],l[0]==="("&&n++)}return i}).map(r=>\`(\${r})\`).join(t)}var Mr=/\\b\\B/,In="[a-zA-Z]\\\\w*",vt="[a-zA-Z_]\\\\w*",Mn="\\\\b\\\\d+(\\\\.\\\\d+)?",On="(-?)(\\\\b0[xX][a-fA-F0-9]+|(\\\\b\\\\d+(\\\\.\\\\d*)?|\\\\.\\\\d+)([eE][-+]?\\\\d+)?)",Ln="\\\\b(0b[01]+)",Or="!|!=|!==|%|%=|&|&&|&=|\\\\*|\\\\*=|\\\\+|\\\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\\\?|\\\\[|\\\\{|\\\\(|\\\\^|\\\\^=|\\\\||\\\\|=|\\\\|\\\\||~",Lr=(e={})=>{let t=/^#![ ]*\\//;return e.binary&&(e.begin=be(t,/.*\\b/,e.binary,/\\b.*/)),ae({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,r)=>{n.index!==0&&r.ignoreMatch()}},e)},De={begin:"\\\\\\\\[\\\\s\\\\S]",relevance:0},Dr={scope:"string",begin:"'",end:"'",illegal:"\\\\n",contains:[De]},Br={scope:"string",begin:'"',end:'"',illegal:"\\\\n",contains:[De]},$r={begin:/\\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\\b/},Ve=function(e,t,n={}){let r=ae({scope:"comment",begin:e,end:t,contains:[]},n);r.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let s=_t("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return r.contains.push({begin:be(/[ ]+/,"(",s,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),r},Pr=Ve("//","$"),zr=Ve("/\\\\*","\\\\*/"),Ur=Ve("#","$"),Hr={scope:"number",begin:Mn,relevance:0},Fr={scope:"number",begin:On,relevance:0},Gr={scope:"number",begin:Ln,relevance:0},qr={scope:"regexp",begin:/\\/(?=[^/\\n]*\\/)/,end:/\\/[gimuy]*/,contains:[De,{begin:/\\[/,end:/\\]/,relevance:0,contains:[De]}]},Zr={scope:"title",begin:In,relevance:0},Kr={scope:"title",begin:vt,relevance:0},Wr={begin:"\\\\.\\\\s*"+vt,relevance:0},jr=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})},Xe=Object.freeze({__proto__:null,APOS_STRING_MODE:Dr,BACKSLASH_ESCAPE:De,BINARY_NUMBER_MODE:Gr,BINARY_NUMBER_RE:Ln,COMMENT:Ve,C_BLOCK_COMMENT_MODE:zr,C_LINE_COMMENT_MODE:Pr,C_NUMBER_MODE:Fr,C_NUMBER_RE:On,END_SAME_AS_BEGIN:jr,HASH_COMMENT_MODE:Ur,IDENT_RE:In,MATCH_NOTHING_RE:Mr,METHOD_GUARD:Wr,NUMBER_MODE:Hr,NUMBER_RE:Mn,PHRASAL_WORDS_MODE:$r,QUOTE_STRING_MODE:Br,REGEXP_MODE:qr,RE_STARTERS_RE:Or,SHEBANG:Lr,TITLE_MODE:Zr,UNDERSCORE_IDENT_RE:vt,UNDERSCORE_TITLE_MODE:Kr});function Xr(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function Yr(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function Qr(e,t){t&&e.beginKeywords&&(e.begin="\\\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\\\.)(?=\\\\b|\\\\s)",e.__beforeBegin=Xr,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function Vr(e,t){Array.isArray(e.illegal)&&(e.illegal=_t(...e.illegal))}function Jr(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function ei(e,t){e.relevance===void 0&&(e.relevance=1)}var ti=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let n=Object.assign({},e);Object.keys(e).forEach(r=>{delete e[r]}),e.keywords=n.keywords,e.begin=be(n.beforeMatch,Nn(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},ni=["of","and","for","in","not","or","if","then","parent","list","value"],si="keyword";function Dn(e,t,n=si){let r=Object.create(null);return typeof e=="string"?s(n,e.split(" ")):Array.isArray(e)?s(n,e):Object.keys(e).forEach(function(a){Object.assign(r,Dn(e[a],t,a))}),r;function s(a,i){t&&(i=i.map(l=>l.toLowerCase())),i.forEach(function(l){let o=l.split("|");r[o[0]]=[a,ri(o[0],o[1])]})}}function ri(e,t){return t?Number(t):ii(e)?0:1}function ii(e){return ni.includes(e.toLowerCase())}var _n={},me=e=>{console.error(e)},Sn=(e,...t)=>{console.log(\`WARN: \${e}\`,...t)},xe=(e,t)=>{_n[\`\${e}/\${t}\`]||(console.log(\`Deprecated as of \${e}. \${t}\`),_n[\`\${e}/\${t}\`]=!0)},Qe=new Error;function Bn(e,t,{key:n}){let r=0,s=e[n],a={},i={};for(let l=1;l<=t.length;l++)i[l+r]=s[l],a[l+r]=!0,r+=Cn(t[l-1]);e[n]=i,e[n]._emit=a,e[n]._multi=!0}function ai(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw me("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Qe;if(typeof e.beginScope!="object"||e.beginScope===null)throw me("beginScope must be object"),Qe;Bn(e,e.begin,{key:"beginScope"}),e.begin=St(e.begin,{joinWith:""})}}function oi(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw me("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Qe;if(typeof e.endScope!="object"||e.endScope===null)throw me("endScope must be object"),Qe;Bn(e,e.end,{key:"endScope"}),e.end=St(e.end,{joinWith:""})}}function li(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function ci(e){li(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),ai(e),oi(e)}function ui(e){function t(i,l){return new RegExp(Le(i),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(l?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(l,o){o.position=this.position++,this.matchIndexes[this.matchAt]=o,this.regexes.push([o,l]),this.matchAt+=Cn(l)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let l=this.regexes.map(o=>o[1]);this.matcherRe=t(St(l,{joinWith:"|"}),!0),this.lastIndex=0}exec(l){this.matcherRe.lastIndex=this.lastIndex;let o=this.matcherRe.exec(l);if(!o)return null;let c=o.findIndex((d,g)=>g>0&&d!==void 0),u=this.matchIndexes[c];return o.splice(0,c),Object.assign(o,u)}}class r{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(l){if(this.multiRegexes[l])return this.multiRegexes[l];let o=new n;return this.rules.slice(l).forEach(([c,u])=>o.addRule(c,u)),o.compile(),this.multiRegexes[l]=o,o}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(l,o){this.rules.push([l,o]),o.type==="begin"&&this.count++}exec(l){let o=this.getMatcher(this.regexIndex);o.lastIndex=this.lastIndex;let c=o.exec(l);if(this.resumingScanAtSamePosition()&&!(c&&c.index===this.lastIndex)){let u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,c=u.exec(l)}return c&&(this.regexIndex+=c.position+1,this.regexIndex===this.count&&this.considerAll()),c}}function s(i){let l=new r;return i.contains.forEach(o=>l.addRule(o.begin,{rule:o,type:"begin"})),i.terminatorEnd&&l.addRule(i.terminatorEnd,{type:"end"}),i.illegal&&l.addRule(i.illegal,{type:"illegal"}),l}function a(i,l){let o=i;if(i.isCompiled)return o;[Yr,Jr,ci,ti].forEach(u=>u(i,l)),e.compilerExtensions.forEach(u=>u(i,l)),i.__beforeBegin=null,[Qr,Vr,ei].forEach(u=>u(i,l)),i.isCompiled=!0;let c=null;return typeof i.keywords=="object"&&i.keywords.$pattern&&(i.keywords=Object.assign({},i.keywords),c=i.keywords.$pattern,delete i.keywords.$pattern),c=c||/\\w+/,i.keywords&&(i.keywords=Dn(i.keywords,e.case_insensitive)),o.keywordPatternRe=t(c,!0),l&&(i.begin||(i.begin=/\\B|\\b/),o.beginRe=t(o.begin),!i.end&&!i.endsWithParent&&(i.end=/\\B|\\b/),i.end&&(o.endRe=t(o.end)),o.terminatorEnd=Le(o.end)||"",i.endsWithParent&&l.terminatorEnd&&(o.terminatorEnd+=(i.end?"|":"")+l.terminatorEnd)),i.illegal&&(o.illegalRe=t(i.illegal)),i.contains||(i.contains=[]),i.contains=[].concat(...i.contains.map(function(u){return di(u==="self"?i:u)})),i.contains.forEach(function(u){a(u,o)}),i.starts&&a(i.starts,l),o.matcher=s(o),o}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains \`self\` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=ae(e.classNameAliases||{}),a(e)}function $n(e){return e?e.endsWithParent||$n(e.starts):!1}function di(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return ae(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:$n(e)?ae(e,{starts:e.starts?ae(e.starts):null}):Object.isFrozen(e)?ae(e):e}var pi="11.11.1",wt=class extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}},kt=Rn,vn=ae,An=Symbol("nomatch"),gi=7,Pn=function(e){let t=Object.create(null),n=Object.create(null),r=[],s=!0,a="Could not find the language '{}', did you forget to load/include a language module?",i={disableAutodetect:!0,name:"Plain text",contains:[]},l={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\\blang(?:uage)?-([\\w-]+)\\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:yt};function o(p){return l.noHighlightRe.test(p)}function c(p){let b=p.className+" ";b+=p.parentNode?p.parentNode.className:"";let m=l.languageDetectRe.exec(b);if(m){let w=z(m[1]);return w||(Sn(a.replace("{}",m[1])),Sn("Falling back to no-highlight mode for this block.",p)),w?m[1]:"no-highlight"}return b.split(/\\s+/).find(w=>o(w)||z(w))}function u(p,b,m){let w="",v="";typeof b=="object"?(w=p,m=b.ignoreIllegals,v=b.language):(xe("10.7.0","highlight(lang, code, ...args) has been deprecated."),xe("10.7.0",\`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277\`),v=p,w=b),m===void 0&&(m=!0);let M={code:w,language:v};ie("before:highlight",M);let U=M.result?M.result:d(M.language,M.code,m);return U.code=M.code,ie("after:highlight",U),U}function d(p,b,m,w){let v=Object.create(null);function M(h,k){return h.keywords[k]}function U(){if(!y.keywords){D.addText(R);return}let h=0;y.keywordPatternRe.lastIndex=0;let k=y.keywordPatternRe.exec(R),_="";for(;k;){_+=R.substring(h,k.index);let T=ee.case_insensitive?k[0].toLowerCase():k[0],H=M(y,T);if(H){let[ne,As]=H;if(D.addText(_),_="",v[T]=(v[T]||0)+1,v[T]<=gi&&(Fe+=As),ne.startsWith("_"))_+=k[0];else{let Ts=ee.classNameAliases[ne]||ne;J(k[0],Ts)}}else _+=k[0];h=y.keywordPatternRe.lastIndex,k=y.keywordPatternRe.exec(R)}_+=R.substring(h),D.addText(_)}function V(){if(R==="")return;let h=null;if(typeof y.subLanguage=="string"){if(!t[y.subLanguage]){D.addText(R);return}h=d(y.subLanguage,R,!0,Vt[y.subLanguage]),Vt[y.subLanguage]=h._top}else h=E(R,y.subLanguage.length?y.subLanguage:null);y.relevance>0&&(Fe+=h.relevance),D.__addSublanguage(h._emitter,h.language)}function W(){y.subLanguage!=null?V():U(),R=""}function J(h,k){h!==""&&(D.startScope(k),D.addText(h),D.endScope())}function jt(h,k){let _=1,T=k.length-1;for(;_<=T;){if(!h._emit[_]){_++;continue}let H=ee.classNameAliases[h[_]]||h[_],ne=k[_];H?J(ne,H):(R=ne,U(),R=""),_++}}function Xt(h,k){return h.scope&&typeof h.scope=="string"&&D.openNode(ee.classNameAliases[h.scope]||h.scope),h.beginScope&&(h.beginScope._wrap?(J(R,ee.classNameAliases[h.beginScope._wrap]||h.beginScope._wrap),R=""):h.beginScope._multi&&(jt(h.beginScope,k),R="")),y=Object.create(h,{parent:{value:y}}),y}function Yt(h,k,_){let T=Cr(h.endRe,_);if(T){if(h["on:end"]){let H=new Ye(h);h["on:end"](k,H),H.isMatchIgnored&&(T=!1)}if(T){for(;h.endsParent&&h.parent;)h=h.parent;return h}}if(h.endsWithParent)return Yt(h.parent,k,_)}function ys(h){return y.matcher.regexIndex===0?(R+=h[0],1):(it=!0,0)}function ws(h){let k=h[0],_=h.rule,T=new Ye(_),H=[_.__beforeBegin,_["on:begin"]];for(let ne of H)if(ne&&(ne(h,T),T.isMatchIgnored))return ys(k);return _.skip?R+=k:(_.excludeBegin&&(R+=k),W(),!_.returnBegin&&!_.excludeBegin&&(R=k)),Xt(_,h),_.returnBegin?0:k.length}function _s(h){let k=h[0],_=b.substring(h.index),T=Yt(y,h,_);if(!T)return An;let H=y;y.endScope&&y.endScope._wrap?(W(),J(k,y.endScope._wrap)):y.endScope&&y.endScope._multi?(W(),jt(y.endScope,h)):H.skip?R+=k:(H.returnEnd||H.excludeEnd||(R+=k),W(),H.excludeEnd&&(R=k));do y.scope&&D.closeNode(),!y.skip&&!y.subLanguage&&(Fe+=y.relevance),y=y.parent;while(y!==T.parent);return T.starts&&Xt(T.starts,h),H.returnEnd?0:k.length}function Ss(){let h=[];for(let k=y;k!==ee;k=k.parent)k.scope&&h.unshift(k.scope);h.forEach(k=>D.openNode(k))}let He={};function Qt(h,k){let _=k&&k[0];if(R+=h,_==null)return W(),0;if(He.type==="begin"&&k.type==="end"&&He.index===k.index&&_===""){if(R+=b.slice(k.index,k.index+1),!s){let T=new Error(\`0 width match regex (\${p})\`);throw T.languageName=p,T.badRule=He.rule,T}return 1}if(He=k,k.type==="begin")return ws(k);if(k.type==="illegal"&&!m){let T=new Error('Illegal lexeme "'+_+'" for mode "'+(y.scope||"<unnamed>")+'"');throw T.mode=y,T}else if(k.type==="end"){let T=_s(k);if(T!==An)return T}if(k.type==="illegal"&&_==="")return R+=\`
\`,1;if(rt>1e5&&rt>k.index*3)throw new Error("potential infinite loop, way more iterations than matches");return R+=_,_.length}let ee=z(p);if(!ee)throw me(a.replace("{}",p)),new Error('Unknown language: "'+p+'"');let vs=ui(ee),st="",y=w||vs,Vt={},D=new l.__emitter(l);Ss();let R="",Fe=0,de=0,rt=0,it=!1;try{if(ee.__emitTokens)ee.__emitTokens(b,D);else{for(y.matcher.considerAll();;){rt++,it?it=!1:y.matcher.considerAll(),y.matcher.lastIndex=de;let h=y.matcher.exec(b);if(!h)break;let k=b.substring(de,h.index),_=Qt(k,h);de=h.index+_}Qt(b.substring(de))}return D.finalize(),st=D.toHTML(),{language:p,value:st,relevance:Fe,illegal:!1,_emitter:D,_top:y}}catch(h){if(h.message&&h.message.includes("Illegal"))return{language:p,value:kt(b),illegal:!0,relevance:0,_illegalBy:{message:h.message,index:de,context:b.slice(de-100,de+100),mode:h.mode,resultSoFar:st},_emitter:D};if(s)return{language:p,value:kt(b),illegal:!1,relevance:0,errorRaised:h,_emitter:D,_top:y};throw h}}function g(p){let b={value:kt(p),illegal:!1,relevance:0,_top:i,_emitter:new l.__emitter(l)};return b._emitter.addText(p),b}function E(p,b){b=b||l.languages||Object.keys(t);let m=g(p),w=b.filter(z).filter(Ee).map(W=>d(W,p,!1));w.unshift(m);let v=w.sort((W,J)=>{if(W.relevance!==J.relevance)return J.relevance-W.relevance;if(W.language&&J.language){if(z(W.language).supersetOf===J.language)return 1;if(z(J.language).supersetOf===W.language)return-1}return 0}),[M,U]=v,V=M;return V.secondBest=U,V}function f(p,b,m){let w=b&&n[b]||m;p.classList.add("hljs"),p.classList.add(\`language-\${w}\`)}function x(p){let b=null,m=c(p);if(o(m))return;if(ie("before:highlightElement",{el:p,language:m}),p.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset \`dataset.highlighted\`.",p);return}if(p.children.length>0&&(l.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(p)),l.throwUnescapedHTML))throw new wt("One of your code blocks includes unescaped HTML.",p.innerHTML);b=p;let w=b.textContent,v=m?u(w,{language:m,ignoreIllegals:!0}):E(w);p.innerHTML=v.value,p.dataset.highlighted="yes",f(p,m,v.language),p.result={language:v.language,re:v.relevance,relevance:v.relevance},v.secondBest&&(p.secondBest={language:v.secondBest.language,relevance:v.secondBest.relevance}),ie("after:highlightElement",{el:p,result:v,text:w})}function C(p){l=vn(l,p)}let O=()=>{P(),xe("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function L(){P(),xe("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let $=!1;function P(){function p(){P()}if(document.readyState==="loading"){$||window.addEventListener("DOMContentLoaded",p,!1),$=!0;return}document.querySelectorAll(l.cssSelector).forEach(x)}function I(p,b){let m=null;try{m=b(e)}catch(w){if(me("Language definition for '{}' could not be registered.".replace("{}",p)),s)me(w);else throw w;m=i}m.name||(m.name=p),t[p]=m,m.rawDefinition=b.bind(null,e),m.aliases&&K(m.aliases,{languageName:p})}function N(p){delete t[p];for(let b of Object.keys(n))n[b]===p&&delete n[b]}function ue(){return Object.keys(t)}function z(p){return p=(p||"").toLowerCase(),t[p]||t[n[p]]}function K(p,{languageName:b}){typeof p=="string"&&(p=[p]),p.forEach(m=>{n[m.toLowerCase()]=b})}function Ee(p){let b=z(p);return b&&!b.disableAutodetect}function Ae(p){p["before:highlightBlock"]&&!p["before:highlightElement"]&&(p["before:highlightElement"]=b=>{p["before:highlightBlock"](Object.assign({block:b.el},b))}),p["after:highlightBlock"]&&!p["after:highlightElement"]&&(p["after:highlightElement"]=b=>{p["after:highlightBlock"](Object.assign({block:b.el},b))})}function Te(p){Ae(p),r.push(p)}function Re(p){let b=r.indexOf(p);b!==-1&&r.splice(b,1)}function ie(p,b){let m=p;r.forEach(function(w){w[m]&&w[m](b)})}function Ne(p){return xe("10.7.0","highlightBlock will be removed entirely in v12.0"),xe("10.7.0","Please use highlightElement now."),x(p)}Object.assign(e,{highlight:u,highlightAuto:E,highlightAll:P,highlightElement:x,highlightBlock:Ne,configure:C,initHighlighting:O,initHighlightingOnLoad:L,registerLanguage:I,unregisterLanguage:N,listLanguages:ue,getLanguage:z,registerAliases:K,autoDetection:Ee,inherit:vn,addPlugin:Te,removePlugin:Re}),e.debugMode=function(){s=!1},e.safeMode=function(){s=!0},e.versionString=pi,e.regex={concat:be,lookahead:Nn,either:_t,optional:Rr,anyNumberOfTimes:Tr};for(let p in Xe)typeof Xe[p]=="object"&&Tn(Xe[p]);return Object.assign(e,Xe),e},ye=Pn({});ye.newInstance=()=>Pn({});zn.exports=ye;ye.HighlightJS=ye;ye.default=ye});var j=null;function en(e){function t(){j=new WebSocket("ws://"+location.host),j.onopen=function(){e.onOpen()},j.onclose=function(){j=null,e.onClose(),setTimeout(t,2e3)},j.onmessage=function(n){try{let r=JSON.parse(n.data);e.onMessage(r)}catch{}},j.onerror=function(){}}t()}function pe(e){j&&j.readyState===WebSocket.OPEN&&j.send(JSON.stringify(e))}function tn(){return j!==null&&j.readyState===WebSocket.OPEN}function ct(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var fe=ct();function cn(e){fe=e}var ge={exec:()=>null};function S(e,t=""){let n=typeof e=="string"?e:e.source,r={replace:(s,a)=>{let i=typeof a=="string"?a:a.source;return i=i.replace(q.caret,"$1"),n=n.replace(s,i),r},getRegex:()=>new RegExp(n,t)};return r}var Bs=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),q={codeRemoveIndent:/^(?: {1,4}| {0,3}\\t)/gm,outputLinkReplace:/\\\\([\\[\\]])/g,indentCodeCompensation:/^(\\s+)(?:\`\`\`)/,beginningSpace:/^\\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\\n/g,tabCharGlobal:/\\t/g,multipleSpaceGlobal:/\\s+/g,blankLine:/^[ \\t]*$/,doubleBlankLine:/\\n[ \\t]*\\n[ \\t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\\n {0,3}((?:=+|-+) *)(?=\\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \\t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\\[[ xX]\\] +\\S/,listReplaceTask:/^\\[[ xX]\\] +/,listTaskCheckbox:/\\[[ xX]\\]/,anyLine:/\\n.*\\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\\||\\| *$/g,tableRowBlankLine:/\\n[ \\t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\\s|>)/i,endPreScriptTag:/^<\\/(pre|code|kbd|script)(\\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\\s])\\s+(['"])(.*)\\2/,unicodeAlphaNumeric:/[\\p{L}\\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\\w+);)/g,unescapeTest:/&(#(?:\\d+)|(?:#x[0-9A-Fa-f]+)|(?:\\w+));?/ig,caret:/(^|[^\\[])\\^/g,percentDecode:/%25/g,findPipe:/\\|/g,splitPipe:/ \\|/,slashPipe:/\\\\\\|/g,carriageReturn:/\\r\\n|\\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\\S*/,endingNewline:/\\n$/,listItemRegex:e=>new RegExp(\`^( {0,3}\${e})((?:[	 ][^\\\\n]*)?(?:\\\\n|$))\`),nextBulletRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:[*+-]|\\\\d{1,9}[.)])((?:[ 	][^\\\\n]*)?(?:\\\\n|$))\`),hrRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\\\* *){3,})(?:\\\\n+|$)\`),fencesBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}(?:\\\`\\\`\\\`|~~~)\`),headingBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}#\`),htmlBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}<(?:[a-z].*>|!--)\`,"i"),blockquoteBeginRegex:e=>new RegExp(\`^ {0,\${Math.min(3,e-1)}}>\`)},$s=/^(?:[ \\t]*(?:\\n|$))+/,Ps=/^((?: {4}| {0,3}\\t)[^\\n]+(?:\\n(?:[ \\t]*(?:\\n|$))*)?)+/,zs=/^ {0,3}(\`{3,}(?=[^\`\\n]*(?:\\n|$))|~{3,})([^\\n]*)(?:\\n|$)(?:|([\\s\\S]*?)(?:\\n|$))(?: {0,3}\\1[~\`]* *(?=\\n|$)|$)/,Oe=/^ {0,3}((?:-[\\t ]*){3,}|(?:_[ \\t]*){3,}|(?:\\*[ \\t]*){3,})(?:\\n+|$)/,Us=/^ {0,3}(#{1,6})(?=\\s|$)(.*)(?:\\n+|$)/,ut=/ {0,3}(?:[*+-]|\\d{1,9}[.)])/,un=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\\n(?!\\s*?\\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,dn=S(un).replace(/bull/g,ut).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/\\|table/g,"").getRegex(),Hs=S(un).replace(/bull/g,ut).replace(/blockCode/g,/(?: {4}| {0,3}\\t)/).replace(/fences/g,/ {0,3}(?:\`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\\n>]+>\\n/).replace(/table/g,/ {0,3}\\|?(?:[:\\- ]*\\|)+[\\:\\- ]*\\n/).getRegex(),dt=/^([^\\n]+(?:\\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\\n)[^\\n]+)*)/,Fs=/^[^\\n]+/,pt=/(?!\\s*\\])(?:\\\\[\\s\\S]|[^\\[\\]\\\\])+/,Gs=S(/^ {0,3}\\[(label)\\]: *(?:\\n[ \\t]*)?([^<\\s][^\\s]*|<.*?>)(?:(?: +(?:\\n[ \\t]*)?| *\\n[ \\t]*)(title))? *(?:\\n+|$)/).replace("label",pt).replace("title",/(?:"(?:\\\\"?|[^"\\\\])*"|'[^'\\n]*(?:\\n[^'\\n]+)*\\n?'|\\([^()]*\\))/).getRegex(),qs=S(/^(bull)([ \\t][^\\n]+?)?(?:\\n|$)/).replace(/bull/g,ut).getRegex(),We="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",gt=/<!--(?:-?>|[\\s\\S]*?(?:-->|$))/,Zs=S("^ {0,3}(?:<(script|pre|style|textarea)[\\\\s>][\\\\s\\\\S]*?(?:</\\\\1>[^\\\\n]*\\\\n+|$)|comment[^\\\\n]*(\\\\n+|$)|<\\\\?[\\\\s\\\\S]*?(?:\\\\?>\\\\n*|$)|<![A-Z][\\\\s\\\\S]*?(?:>\\\\n*|$)|<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?(?:\\\\]\\\\]>\\\\n*|$)|</?(tag)(?: +|\\\\n|/?>)[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|<(?!script|pre|style|textarea)([a-z][\\\\w-]*)(?:attribute)*? */?>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$)|</(?!script|pre|style|textarea)[a-z][\\\\w-]*\\\\s*>(?=[ \\\\t]*(?:\\\\n|$))[\\\\s\\\\S]*?(?:(?:\\\\n[ 	]*)+\\\\n|$))","i").replace("comment",gt).replace("tag",We).replace("attribute",/ +[a-zA-Z:_][\\w.:-]*(?: *= *"[^"\\n]*"| *= *'[^'\\n]*'| *= *[^\\s"'=<>\`]+)?/).getRegex(),pn=S(dt).replace("hr",Oe).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",We).getRegex(),Ks=S(/^( {0,3}> ?(paragraph|[^\\n]*)(?:\\n|$))+/).replace("paragraph",pn).getRegex(),ht={blockquote:Ks,code:Ps,def:Gs,fences:zs,heading:Us,hr:Oe,html:Zs,lheading:dn,list:qs,newline:$s,paragraph:pn,table:ge,text:Fs},nn=S("^ *([^\\\\n ].*)\\\\n {0,3}((?:\\\\| *)?:?-+:? *(?:\\\\| *:?-+:? *)*(?:\\\\| *)?)(?:\\\\n((?:(?! *\\\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\\\n|$))*)\\\\n*|$)").replace("hr",Oe).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\\\n]").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",We).getRegex(),Ws={...ht,lheading:Hs,table:nn,paragraph:S(dt).replace("hr",Oe).replace("heading"," {0,3}#{1,6}(?:\\\\s|$)").replace("|lheading","").replace("table",nn).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:\`{3,}(?=[^\`\\\\n]*\\\\n)|~{3,})[^\\\\n]*\\\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\\\t]").replace("html","</?(?:tag)(?: +|\\\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",We).getRegex()},js={...ht,html:S(\`^ *(?:comment *(?:\\\\n|\\\\s*$)|<(tag)[\\\\s\\\\S]+?</\\\\1> *(?:\\\\n{2,}|\\\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\\\s[^'"/>\\\\s]*)*?/?> *(?:\\\\n{2,}|\\\\s*$))\`).replace("comment",gt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\\\b)\\\\w+(?!:|[^\\\\w\\\\s@]*@)\\\\b").getRegex(),def:/^ *\\[([^\\]]+)\\]: *<?([^\\s>]+)>?(?: +(["(][^\\n]+[")]))? *(?:\\n+|$)/,heading:/^(#{1,6})(.*)(?:\\n+|$)/,fences:ge,lheading:/^(.+?)\\n {0,3}(=+|-+) *(?:\\n+|$)/,paragraph:S(dt).replace("hr",Oe).replace("heading",\` *#{1,6} *[^
]\`).replace("lheading",dn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Xs=/^\\\\([!"#$%&'()*+,\\-./:;<=>?@\\[\\]\\\\^_\`{|}~])/,Ys=/^(\`+)([^\`]|[^\`][\\s\\S]*?[^\`])\\1(?!\`)/,gn=/^( {2,}|\\\\)\\n(?!\\s*$)/,Qs=/^(\`+|[^\`])(?:(?= {2,}\\n)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*_]|\\b_|$)|[^ ](?= {2,}\\n)))/,je=/[\\p{P}\\p{S}]/u,ft=/[\\s\\p{P}\\p{S}]/u,hn=/[^\\s\\p{P}\\p{S}]/u,Vs=S(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ft).getRegex(),fn=/(?!~)[\\p{P}\\p{S}]/u,Js=/(?!~)[\\s\\p{P}\\p{S}]/u,er=/(?:[^\\s\\p{P}\\p{S}]|~)/u,mn=/(?![*_])[\\p{P}\\p{S}]/u,tr=/(?![*_])[\\s\\p{P}\\p{S}]/u,nr=/(?:[^\\s\\p{P}\\p{S}]|[*_])/u,sr=S(/link|precode-code|html/,"g").replace("link",/\\[(?:[^\\[\\]\`]|(?<a>\`+)[^\`]+\\k<a>(?!\`))*?\\]\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)]|\\((?:\\\\[\\s\\S]|[^\\\\\\(\\)])*\\))*\\)/).replace("precode-",Bs?"(?<!\`)()":"(^^|[^\`])").replace("code",/(?<b>\`+)[^\`]+\\k<b>(?!\`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),bn=/^(?:\\*+(?:((?!\\*)punct)|[^\\s*]))|^_+(?:((?!_)punct)|([^\\s_]))/,rr=S(bn,"u").replace(/punct/g,je).getRegex(),ir=S(bn,"u").replace(/punct/g,fn).getRegex(),kn="^[^_*]*?__[^_*]*?\\\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\\\*)punct(\\\\*+)(?=[\\\\s]|$)|notPunctSpace(\\\\*+)(?!\\\\*)(?=punctSpace|$)|(?!\\\\*)punctSpace(\\\\*+)(?=notPunctSpace)|[\\\\s](\\\\*+)(?!\\\\*)(?=punct)|(?!\\\\*)punct(\\\\*+)(?!\\\\*)(?=punct)|notPunctSpace(\\\\*+)(?=notPunctSpace)",ar=S(kn,"gu").replace(/notPunctSpace/g,hn).replace(/punctSpace/g,ft).replace(/punct/g,je).getRegex(),or=S(kn,"gu").replace(/notPunctSpace/g,er).replace(/punctSpace/g,Js).replace(/punct/g,fn).getRegex(),lr=S("^[^_*]*?\\\\*\\\\*[^_*]*?_[^_*]*?(?=\\\\*\\\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,hn).replace(/punctSpace/g,ft).replace(/punct/g,je).getRegex(),cr=S(/^~~?(?:((?!~)punct)|[^\\s~])/,"u").replace(/punct/g,mn).getRegex(),ur="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",dr=S(ur,"gu").replace(/notPunctSpace/g,nr).replace(/punctSpace/g,tr).replace(/punct/g,mn).getRegex(),pr=S(/\\\\(punct)/,"gu").replace(/punct/g,je).getRegex(),gr=S(/^<(scheme:[^\\s\\x00-\\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_\`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),hr=S(gt).replace("(?:-->|$)","-->").getRegex(),fr=S("^comment|^</[a-zA-Z][\\\\w:-]*\\\\s*>|^<[a-zA-Z][\\\\w-]*(?:attribute)*?\\\\s*/?>|^<\\\\?[\\\\s\\\\S]*?\\\\?>|^<![a-zA-Z]+\\\\s[\\\\s\\\\S]*?>|^<!\\\\[CDATA\\\\[[\\\\s\\\\S]*?\\\\]\\\\]>").replace("comment",hr).replace("attribute",/\\s+[a-zA-Z:_][\\w.:-]*(?:\\s*=\\s*"[^"]*"|\\s*=\\s*'[^']*'|\\s*=\\s*[^\\s"'=<>\`]+)?/).getRegex(),qe=/(?:\\[(?:\\\\[\\s\\S]|[^\\[\\]\\\\])*\\]|\\\\[\\s\\S]|\`+[^\`]*?\`+(?!\`)|[^\\[\\]\\\\\`])*?/,mr=S(/^!?\\[(label)\\]\\(\\s*(href)(?:(?:[ \\t]*(?:\\n[ \\t]*)?)(title))?\\s*\\)/).replace("label",qe).replace("href",/<(?:\\\\.|[^\\n<>\\\\])+>|[^ \\t\\n\\x00-\\x1f]*/).replace("title",/"(?:\\\\"?|[^"\\\\])*"|'(?:\\\\'?|[^'\\\\])*'|\\((?:\\\\\\)?|[^)\\\\])*\\)/).getRegex(),En=S(/^!?\\[(label)\\]\\[(ref)\\]/).replace("label",qe).replace("ref",pt).getRegex(),xn=S(/^!?\\[(ref)\\](?:\\[\\])?/).replace("ref",pt).getRegex(),br=S("reflink|nolink(?!\\\\()","g").replace("reflink",En).replace("nolink",xn).getRegex(),sn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,mt={_backpedal:ge,anyPunctuation:pr,autolink:gr,blockSkip:sr,br:gn,code:Ys,del:ge,delLDelim:ge,delRDelim:ge,emStrongLDelim:rr,emStrongRDelimAst:ar,emStrongRDelimUnd:lr,escape:Xs,link:mr,nolink:xn,punctuation:Vs,reflink:En,reflinkSearch:br,tag:fr,text:Qs,url:ge},kr={...mt,link:S(/^!?\\[(label)\\]\\((.*?)\\)/).replace("label",qe).getRegex(),reflink:S(/^!?\\[(label)\\]\\s*\\[([^\\]]*)\\]/).replace("label",qe).getRegex()},at={...mt,emStrongRDelimAst:or,emStrongLDelim:ir,delLDelim:cr,delRDelim:dr,url:S(/^((?:protocol):\\/\\/|www\\.)(?:[a-zA-Z0-9\\-]+\\.?)+[^\\s<]*|^email/).replace("protocol",sn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\\([^)]*\\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\\s~])((?:\\\\[\\s\\S]|[^\\\\])*?(?:\\\\[\\s\\S]|[^\\s~\\\\]))\\1(?=[^~]|$)/,text:S(/^([\`~]+|[^\`~])(?:(?= {2,}\\n)|(?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)|[\\s\\S]*?(?:(?=[\\\\<!\\[\`*~_]|\\b_|protocol:\\/\\/|www\\.|$)|[^ ](?= {2,}\\n)|[^a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-](?=[a-zA-Z0-9.!#$%&'*+\\/=?_\`{\\|}~-]+@)))/).replace("protocol",sn).getRegex()},Er={...at,br:S(gn).replace("{2,}","*").getRegex(),text:S(at.text).replace("\\\\b_","\\\\b_| {2,}\\\\n").replace(/\\{2,\\}/g,"*").getRegex()},Ge={normal:ht,gfm:Ws,pedantic:js},Ce={normal:mt,gfm:at,breaks:Er,pedantic:kr},xr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},rn=e=>xr[e];function te(e,t){if(t){if(q.escapeTest.test(e))return e.replace(q.escapeReplace,rn)}else if(q.escapeTestNoEncode.test(e))return e.replace(q.escapeReplaceNoEncode,rn);return e}function an(e){try{e=encodeURI(e).replace(q.percentDecode,"%")}catch{return null}return e}function on(e,t){let n=e.replace(q.findPipe,(a,i,l)=>{let o=!1,c=i;for(;--c>=0&&l[c]==="\\\\";)o=!o;return o?"|":" |"}),r=n.split(q.splitPipe),s=0;if(r[0].trim()||r.shift(),r.length>0&&!r.at(-1)?.trim()&&r.pop(),t)if(r.length>t)r.splice(t);else for(;r.length<t;)r.push("");for(;s<r.length;s++)r[s]=r[s].trim().replace(q.slashPipe,"|");return r}function Ie(e,t,n){let r=e.length;if(r===0)return"";let s=0;for(;s<r;){let a=e.charAt(r-s-1);if(a===t&&!n)s++;else if(a!==t&&n)s++;else break}return e.slice(0,r-s)}function yr(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]==="\\\\")r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function wr(e,t=0){let n=t,r="";for(let s of e)if(s==="	"){let a=4-n%4;r+=" ".repeat(a),n+=a}else r+=s,n++;return r}function ln(e,t,n,r,s){let a=t.href,i=t.title||null,l=e[1].replace(s.other.outputLinkReplace,"$1");r.state.inLink=!0;let o={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:a,title:i,text:l,tokens:r.inlineTokens(l)};return r.state.inLink=!1,o}function _r(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let s=r[1];return t.split(\`
